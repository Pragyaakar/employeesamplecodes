		...
		function suiteletInvoiceFixedFeeLayout(request, response)
		{
			...
			if (fixedFeeSearchResults != null && fixedFeeSearchResults != '')
			{
				...
				if(expSearchResults !=null )
				{
					for(var ac=0 ; ac<expSearchResults.length;ac++)
					{
					 ...
					 if(tax_Subsidiary == 'AST LLC' || tax_Subsidiary == 'Serene AST LLC')
					 {
							...
							strName += "<td table-layout = \"fixed\" border-bottom=\"0.5\" font-size=\"10\" align=\"center\">"+USD_currency+"</td>";
							strName += "<td table-layout = \"fixed\" border-bottom=\"0.5\" width = \"10\%\" font-size=\"10\" align=\"right\">"+parseFloat(FinFxAmt).toFixed(2)+"</td>";
							strName += "</tr>";
					 }
					 else
					 {
			    ...
			    if(tax_Subsidiary == 'AST LLC' || tax_Subsidiary == 'Serene AST LLC')
				{
					...
					strName += "<td border-top=\"0.5\" border-bottom=\"0.5\" width = \"10\%\" font-size=\"10\" align=\"left\"><b>"+currency+"</b></td>";
...
//*************************************DETAIL EXPENSE DETAIL**********************************
					...
					//**********************************Expense Table*********************************
						...
						else
						{
							...
							strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"36\%\" font-size=\"10\"><b>Expense SubTotal</b></td>";
							strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"15\%\" font-size=\"10\" align=\"right\"></td>";
							strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"15\%\" font-size=\"10\"><b>"+can_dollar+"</b></td>";
							strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"23\%\" font-size=\"10\" align=\"right\"><b>"+final_expresourceTotal1+"</b></td>";
							strName += "</tr>";
						}
							...
							else
							{
									...
									strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"15\%\" font-size=\"10\"><b>"+nlapiEscapeXML(ExpCurrency)+"</b></td>";
									strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"23\%\" font-size=\"10\" align=\"right\"><b>"+final_total_tot+"</b></td>";
									strName += "</tr>";
									...
									strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"25\%\" font-size=\"10\"><b>GST/HST Tax</b></td>";
									...
									strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"23\%\" font-size=\"10\" align=\"right\"><b>"+final_tax_taxSub_tot+"</b></td>";
									strName += "</tr>";
									...
									strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"15\%\" font-size=\"10\" align=\"right\"></td>";
									strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"15\%\" font-size=\"10\" align=\"right\"><b>"+nlapiEscapeXML(ExpCurrency)+"</b></td>";
									strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"23\%\" font-size=\"10\" align=\"right\"><b>"+final_grand_total+"</b></td>";
									strName += "</tr>";	
							}
						}
						strName += "</table><br/>";

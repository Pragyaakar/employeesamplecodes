...
function suiteletInvoiceFixedFeeLayout(request, response)
{
	...
	for (var x = 1; x <= numberOfAddress; x++)
	{
		...
		if(count >=1)
		{
			...
			for (var zz=1;zz<=count;zz++)
			{
				var TaxRate = ffReqObj.getLineItemValue('item','taxrate1',zz);
		...
		if(count1 >=1)
		{
			...
			for (var zz1=1;zz1<=count1;zz1++)
			{
				var apply1 = ffReqObj.getLineItemValue('expcost','apply',zz1);
				if( apply1 == "T")
				{
					var ExptaxRate = ffReqObj.getLineItemValue('expcost','taxrate1',zz1);
		...
		if(proj != null)
		{
			...
			var index = 0;
			 var res = [];
			while ((index = res_Proj.indexOf(' ', index + 1)) > 0)
			{
			    res.push(index);
			}
			...
			{
				var res_Proj1 = res_Proj.substr(0,res[2]);
				var res_Proj2 = res_Proj.substr(res[2],res_Proj.length);
			}
		}	
		else
		{
		...
		if(tax_Subsidiary == 'Serene AST LLC')
		{
			...
			strName += "<td colspan =\"8\" font-size=\"10\"></td>";
			strName += "<td colspan =\"8\" width = \"100\%\"  align=\"right\" font-size=\"20\" margin-top=\"20px\"><b>INVOICE</b></td>";
			strName += "</tr>";
			strName += "</table>";
		}
		else
		...
		if(tax_Subsidiary == 'AST LLC' || tax_Subsidiary == 'Serene AST LLC')
		{
			if(billcontName == '')
			{
				...
				if(res[2] != null && res[2] !='' && res[2] != undefined)
				{
					strName += "<td border-top=\"0.2\" width = \"55\%\" align=\"left\" font-size=\"10\" table-layout = \"fixed\"><b>Invoice&nbsp;</b>#:&nbsp;"+Invoice_no+"<br/><b>Date:&nbsp;</b>"+Time_period+"<br/><b>Terms:&nbsp;</b>"+terms+"<br/><b>Due:&nbsp;</b>"+due+"<br/><b>Project:</b>"+nlapiEscapeXML(res_Proj1)+"<br/>"+nlapiEscapeXML(res_Proj2)+"<br/><b>Customer PO#:&nbsp;</b>"+nlapiEscapeXML(po_no)+"<br/></td>";
					
				}
				else
				{
					strName += "<td border-top=\"0.2\" width = \"55\%\" align=\"left\" font-size=\"10\" table-layout = \"fixed\"><b>Invoice&nbsp;</b>#:&nbsp;"+Invoice_no+"<br/><b>Date:&nbsp;</b>"+Time_period+"<br/><b>Terms:&nbsp;</b>"+terms+"<br/><b>Due:&nbsp;</b>"+due+"<br/><b>Project:</b>"+nlapiEscapeXML(res_Proj)+"<br/><b>Customer PO#:&nbsp;</b>"+nlapiEscapeXML(po_no)+"<br/></td>";
						
				}
				strName += "<td border-top=\"0.2\" width = \"15\%\" align=\"left\" font-size=\"10\" table-layout = \"fixed\"></td>";
				strName += "<td border-top=\"0.2\" width = \"53\%\" align=\"center\" font-size=\"10\" table-layout = \"fixed\" style=\"word-break:break-all;\"><b>To</b><br/>"+nlapiEscapeXML(address)+"<br/>"+nlapiEscapeXML(addressText1)+"&nbsp;"+nlapiEscapeXML(addressText2)+"<br/>"+nlapiEscapeXML(state)+"<br/>"+zip+"&nbsp;"+nlapiEscapeXML(country)+"</td>";
				strName += "<td border-top=\"0.2\" width = \"5\%\"  align=\"left\" font-size=\"10\" table-layout = \"fixed\"></td>";
				strName += "<td border-top=\"0.2\" width = \"63\%\" align=\"right\" font-size=\"10\" table-layout = \"fixed\" style=\"word-break:break-all;\"><b>From</b><br/>"+nlapiEscapeXML(sub_address)+"<br/>"+nlapiEscapeXML(sub_addressText1)+"&nbsp;"+nlapiEscapeXML(sub_addressText2)+"<br/>"+nlapiEscapeXML(sub_state)+"&nbsp;"+nlapiEscapeXML(sub_zip)+"&nbsp;"+nlapiEscapeXML(sub_country)+"<br/>Email: ar@astcorporation.com <br/>Phone: +1 (630) 778-1180 <br/>Fax: +1 (630) 778-1179</td>";
				strName += "</tr>";	
				strName += "</table ><br/>";
			}
			else
			{
				...
				strName += "<td border-top=\"0.2\" width = \"15\%\" align=\"left\" font-size=\"10\" table-layout = \"fixed\"></td>";
				strName += "<td border-top=\"0.2\" width = \"53\%\" align=\"center\" font-size=\"10\" table-layout = \"fixed\" style=\"word-break:break-all;\"><b>To</b><br/>"+nlapiEscapeXML(billcontName)+"<br/>"+nlapiEscapeXML(address)+"<br/>"+nlapiEscapeXML(addressText1)+"&nbsp;"+nlapiEscapeXML(addressText2)+"<br/>"+nlapiEscapeXML(state)+"&nbsp;"+zip+"&nbsp;"+nlapiEscapeXML(country)+"</td>";
				strName += "<td border-top=\"0.2\" width = \"5\%\"  align=\"left\" font-size=\"10\" table-layout = \"fixed\"></td>";
				strName += "<td border-top=\"0.2\" width = \"63\%\" align=\"right\" font-size=\"10\" table-layout = \"fixed\" style=\"word-break:break-all;\"><b>From</b><br/>"+nlapiEscapeXML(sub_address)+"<br/>"+nlapiEscapeXML(sub_addressText1)+"&nbsp;"+nlapiEscapeXML(sub_addressText2)+"<br/>"+nlapiEscapeXML(sub_state)+"&nbsp;"+sub_zip+"&nbsp;"+nlapiEscapeXML(sub_country)+"<br/>Email: ar@astcorporation.com<br/>Phone: +1 (630) 778-1180 <br/>Fax: +1 (630) 778-1179 </td>";
				strName += "</tr>";	
				strName += "</table ><br/>";
			}
		}
		else if(tax_Subsidiary == 'Serene AST Australia' )
		{
			if(billcontName == '')	
			{
				...
				strName += "<td border-top=\"0.2\" width = \"10\%\" text-align=\"left\" font-size=\"10\" table-layout = \"fixed\"></td>";
				strName += "<td border-top=\"0.2\" width = \"50.9\%\" text-align=\"right\" font-size=\"10\" table-layout = \"fixed\" style=\"word-break:break-all;\"><b>To</b><br/>"+nlapiEscapeXML(address)+"<br/>"+nlapiEscapeXML(addressText1)+"&nbsp;"+nlapiEscapeXML(addressText2)+"<br/>"+nlapiEscapeXML(city)+"&nbsp;"+nlapiEscapeXML(state)+"&nbsp;"+zip+"&nbsp;"+nlapiEscapeXML(country)+"</td>";
				strName += "<td border-top=\"0.2\" width = \"5\%\"  text-align=\"left\" font-size=\"10\" table-layout = \"fixed\"></td>";
				strName += "<td border-top=\"0.2\" width = \"57\%\" text-align=\"right\" font-size=\"10\" table-layout = \"fixed\" style=\"word-break:break-all;\"><b>From</b><br/>"+nlapiEscapeXML(sub_address)+"<br/>"+nlapiEscapeXML(sub_addressText1)+"&nbsp;"+nlapiEscapeXML(sub_addressText2)+"<br/>"+nlapiEscapeXML(sub_city)+"&nbsp;"+nlapiEscapeXML(sub_state)+"&nbsp;"+sub_zip+"&nbsp;"+nlapiEscapeXML(sub_country)+"<br/>Email: ar@astcorporation.com<br/>Phone: +1 (630) 778-1180 <br/>Fax: +1 (630) 778-1179</td>";
				strName += "</tr>";	
				strName += "</table ><br/>";
			}
			else
			{
				...
				strName += "<td border-top=\"0.2\" width = \"10\%\" text-align=\"left\" font-size=\"10\" table-layout = \"fixed\"></td>";
				strName += "<td border-top=\"0.2\" width = \"50\%\" text-align=\"right\" font-size=\"10\" table-layout = \"fixed\" style=\"word-break:break-all;\"><b>To</b><br/>"+nlapiEscapeXML(billcontName)+"<br/>"+nlapiEscapeXML(address)+"<br/>"+nlapiEscapeXML(addressText1)+"&nbsp;"+nlapiEscapeXML(addressText2)+"<br/>"+nlapiEscapeXML(city)+"&nbsp;"+nlapiEscapeXML(state)+"&nbsp;"+zip+"&nbsp;"+nlapiEscapeXML(country)+"</td>";
				strName += "<td border-top=\"0.2\" width = \"5\%\"  text-align=\"left\" font-size=\"10\" table-layout = \"fixed\"></td>";
				strName += "<td border-top=\"0.2\" width = \"57\%\" text-align=\"right\" font-size=\"10\" table-layout = \"fixed\" style=\"word-break:break-all;\"><b>From</b><br/>"+nlapiEscapeXML(sub_address)+"<br/>"+nlapiEscapeXML(sub_addressText1)+"&nbsp;"+nlapiEscapeXML(sub_addressText2)+"<br/>"+nlapiEscapeXML(sub_city)+"&nbsp;"+nlapiEscapeXML(sub_state)+"&nbsp;"+sub_zip+"&nbsp;"+nlapiEscapeXML(sub_country)+"<br/>Email: ar@astcorporation.com<br/>Phone: +1 (630) 778-1180 <br/>Fax: +1 (630) 778-1179<br/>GST/HST #: 741870323RT0001</td>";
				strName += "</tr>";	
				strName += "</table ><br/>";
			}
		}	
		else
		{
			if(billcontName == '')	
			{
				...
				strName += "<td border-top=\"0.2\" width = \"10\%\" text-align=\"left\" font-size=\"10\" table-layout = \"fixed\"></td>";
				strName += "<td border-top=\"0.2\" width = \"50\%\" text-align=\"right\" font-size=\"10\" table-layout = \"fixed\"><b>To</b><br/>"+nlapiEscapeXML(address)+"<br/>"+nlapiEscapeXML(addressText1)+"&nbsp;"+nlapiEscapeXML(addressText2)+"<br/>"+nlapiEscapeXML(state)+"&nbsp;"+zip+"&nbsp;"+nlapiEscapeXML(country)+"</td>";
				strName += "<td border-top=\"0.2\" width = \"5\%\"  text-align=\"left\" font-size=\"10\" table-layout = \"fixed\"></td>";
				strName += "<td border-top=\"0.2\" width = \"50\%\" text-align=\"right\" font-size=\"10\" table-layout = \"fixed\"><b>From</b><br/>"+nlapiEscapeXML(sub_address)+"<br/>"+nlapiEscapeXML(sub_addressText1)+"&nbsp;"+nlapiEscapeXML(sub_addressText2)+"\n"+nlapiEscapeXML(sub_state)+"&nbsp;"+sub_zip+" "+nlapiEscapeXML(sub_country)+"\n Email: ar@astcorporation.com<br/>Phone: +1 (630) 778-1180 <br/>Fax: +1 (630) 778-1179 </td>";
				strName += "</tr>";	
				strName += "</table ><br/>";
			}
			else
			{
				...
				strName += "<td border-top=\"0.2\" width = \"10\%\" text-align=\"left\" font-size=\"10\" table-layout = \"fixed\"></td>";
				strName += "<td border-top=\"0.2\" width = \"50\%\" text-align=\"right\" font-size=\"10\" table-layout = \"fixed\"><b>To</b><br/>"+nlapiEscapeXML(billcontName)+"<br/>"+nlapiEscapeXML(address)+"<br/>"+nlapiEscapeXML(addressText1)+"&nbsp;"+nlapiEscapeXML(addressText2)+"<br/>"+nlapiEscapeXML(state)+"&nbsp;"+zip+"&nbsp;"+nlapiEscapeXML(country)+"</td>";
				strName += "<td border-top=\"0.2\" width = \"5\%\"  text-align=\"left\" font-size=\"10\" table-layout = \"fixed\"></td>";
				strName += "<td border-top=\"0.2\" width = \"50\%\" text-align=\"right\" font-size=\"10\" table-layout = \"fixed\"><b>From</b><br/>"+nlapiEscapeXML(sub_address)+"<br/>"+nlapiEscapeXML(sub_addressText1)+"&nbsp;"+nlapiEscapeXML(sub_addressText2)+"\n"+nlapiEscapeXML(sub_state)+"&nbsp;"+sub_zip+"&nbsp;"+nlapiEscapeXML(sub_country)+"\n Email: ar@astcorporation.com<br/>Phone: +1 (630) 778-1180 <br/>Fax: +1 (630) 778-1179<br/>GST/HST #: 741870323RT0001</td>";
				strName += "</tr>";	
			    strName += "</table ><br/>";
			}
		}	
...
if(tax_Subsidiary == 'AST LLC' || tax_Subsidiary == 'Serene AST LLC')
{
	strName += "<table width=\"100\%\" font-family=\"Helvetica\">";
	strName += "<tr>";
	strName += "<td border-top=\"0.5\" border-bottom=\"0.5\" width = \"30\%\" font-size=\"10\"><b>Total</b></td>";
	strName += "<td border-top=\"0.5\" border-bottom=\"0.5\" width = \"27\%\" font-size=\"10\"></td>";
	strName += "<td border-top=\"0.5\" border-bottom=\"0.5\" width = \"30\%\" font-size=\"10\" align=\"left\"></td>";
    strName += "<td border-top=\"0.5\" border-bottom=\"0.5\" width = \"25\%\" font-size=\"10\" align=\"right\"></td>";
	strName += "<td border-top=\"0.5\" border-bottom=\"0.5\" width = \"14\%\" font-size=\"10\" align=\"right\"><b>"+currency+"</b></td>";
	strName += "<td border-top=\"0.5\" border-bottom=\"0.5\" width = \"15\%\" font-size=\"10\" align=\"right\"><b>"+formatNumber(parseFloat(EndTot).toFixed(2))+"</b></td>";
	strName += "</tr>";
}
else
{
	...
	strName += "<table width=\"100\%\" font-family=\"Helvetica\">";
	strName += "<tr>";
	strName += "<td border-top=\"0.5\" border-bottom=\"0.5\" width = \"30\%\" font-size=\"10\"><b>SubTotal</b></td>";
	strName += "<td border-top=\"0.5\" border-bottom=\"0.5\" width = \"5\%\" font-size=\"10\"></td>";
	strName += "<td border-top=\"0.5\" border-bottom=\"0.5\" width = \"30\%\" font-size=\"10\" align=\"center\"></td>";
...
if(expSearchResults !=null )	
{
	...
	else if(tax_Subsidiary == 'AST LLC' || tax_Subsidiary == 'Serene AST LLC')
	{
		...
		strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" width = \"13\%\" font-size=\"10\" align=\"left\"><b>"+nlapiEscapeXML(currency11)+"</b></td>";
	...
	else if(tax_Subsidiary == 'Serene AST Australia')
	{
		...
		strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" width = \"25\%\" align=\"right\"></td>"; 
		strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" width = \"13\%\" font-size=\"10\" align=\"left\"><b>"+nlapiEscapeXML(currency11)+"</b></td>";
		strName += "<td table-layout = \"fixed\" border-right=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" width = \"10\%\" align=\"right\"><b>"+ItemTaxRate+"</b></td>";
		strName += "</tr>";
	...
	else
	{
		...
		strName += "<tr>";
		strName += "<td table-layout = \"fixed\" border-right=\"0.2\" border-left=\"0.2\" border-bottom=\"0.2\" width = \"25\%\" font-size=\"10\"><b>GST/HST</b></td>";
		strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" width = \"20\%\" font-size=\"10\" align=\"right\"></td>";
		strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\"></td>";        
		strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" width = \"25\%\" align=\"right\"></td>"; 
		strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" width = \"13\%\" font-size=\"10\" align=\"left\"><b>"+nlapiEscapeXML(currency11)+"</b></td>";
...
if(expSearchResults)
{
	...
	strName += "<table width=\"100\%\" table-layout = \"fixed\" font-family=\"Helvetica\"  >";
	strName += "<tr>";
	strName += "<td table-layout = \"fixed\" border-right=\"0.2\" border-left=\"0.2\" border-top=\"0.2\" border-bottom=\"0.2\" width = \"29\%\" font-size=\"10\"><b>Resource Name</b></td>";
	...
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" font-size=\"10\" align=\"right\" width = \"9\%\"></td>";
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"19\%\" style=\"white-space:nowrap;\"><b>Miscellaneous</b></td>";
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" font-size=\"10\" align=\"right\" width = \"9\%\"></td>";
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"18\%\"><b>Expense<br/>SubTotal</b></td>";
	strName += "</tr>";
		...
		for (var x = 0;  x < expCounsaltantUniq.length; x++) 
		{
			for (var q = 0;  q < expSearchResults.length; q++) 
			{
				...
				if(expCounsaltantUniq[x] == counsaltantName)
				{
					...
					{
						strName += "<tr>";
						strName += "<td table-layout = \"fixed\" border-right=\"0.2\" border-left=\"0.2\" border-bottom=\"0.2\" width = \"29\%\" align=\"left\" font-size=\"10\">"+nlapiEscapeXML(expCounsaltantUniq[x])+"</td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\">"+dollar_sign+"</td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\">"+formatNumber(airFair)+"</td>";         //"+fin_rate+"
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\">"+dollar_sign+"</td>"; 
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\">"+formatNumber(hotel)+"</td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\">"+dollar_sign+"</td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\">"+formatNumber(meals)+" </td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\">"+dollar_sign+"</td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"19\%\">"+formatNumber(miscellaneous)+"</td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"9\%\">"+dollar_sign+"</td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"20\%\">"+final_ExpType_total+"</td>";
						strName += "</tr>";
					}
					else if(tax_Subsidiary == 'Serene AST Australia')
					{
						strName += "<tr>";
						strName += "<td table-layout = \"fixed\" border-right=\"0.2\" border-left=\"0.2\" border-bottom=\"0.2\" width = \"29\%\" align=\"left\" font-size=\"10\">"+nlapiEscapeXML(expCounsaltantUniq[x])+"</td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\">"+aus_dollar+"</td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\">"+formatNumber(airFair)+"</td>";         //"+fin_rate+"
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\">"+aus_dollar+"</td>"; 
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\">"+formatNumber(hotel)+"</td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\">"+aus_dollar+"</td>";
						...
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\">"+aus_dollar+"</td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"19\%\">"+formatNumber(miscellaneous)+"</td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"9\%\">"+aus_dollar+"</td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"20\%\">"+final_ExpType_total+"</td>";
						strName += "</tr>";
					}
					else
					{
						strName += "<tr>";
						strName += "<td table-layout = \"fixed\" border-right=\"0.2\" border-left=\"0.2\" border-bottom=\"0.2\" width = \"29\%\" align=\"left\" font-size=\"10\" >"+nlapiEscapeXML(expCounsaltantUniq[x])+"</td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\">"+can_dollar+"</td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\">"+formatNumber(airFair)+"</td>";         //"+fin_rate+"
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\">"+can_dollar+"</td>"; 
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\">"+formatNumber(hotel)+"</td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\">"+can_dollar+"</td>";
						...
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\">"+can_dollar+"</td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"19\%\">"+formatNumber(miscellaneous)+"</td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"9\%\">"+can_dollar+"</td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"20\%\">"+final_ExpType_total+"</td>";
						strName += "</tr>";
					}
...
{
	strName += "<tr>";
	strName += "<td table-layout = \"fixed\" border-right=\"0.2\" border-left=\"0.2\" border-bottom=\"0.2\" width = \"30\%\" font-size=\"10\"><b>Expense SubTotal</b></td>";
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\">"+dollar_sign+"</td>";
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\">"+formatNumber(subAirfair1)+"</td>";         //"+fin_rate+"
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\">"+dollar_sign+"</td>"; 
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\">"+formatNumber(subhotel1)+"</td>";
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\">"+dollar_sign+"</td>";
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\">"+formatNumber(submeals1)+"</td>";
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\">"+dollar_sign+"</td>";
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"21\%\">"+formatNumber(submisc1)+"</td>";
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"9\%\"><b>"+dollar_sign+"</b></td>";
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"20\%\"><b>"+formatNumber(final_sub)+"</b></td>";
	strName += "</tr>";
}
else if(tax_Subsidiary == 'Serene AST Australia')
{
	...
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\">"+aus_dollar+"</td>";
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"21\%\">"+formatNumber(submisc1)+"</td>";
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"9\%\"><b>"+aus_dollar+"</b></td>";
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"20\%\"><b>"+formatNumber(final_sub)+"</b></td>";
	strName += "</tr>";
}
else
{
    ...
    strName += "<td table-layout = \"fixed\" border-right=\"0.2\" border-left=\"0.2\" border-bottom=\"0.2\" width = \"30\%\" font-size=\"10\"><b>Expense SubTotal</b></td>";
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\">"+can_dollar+"</td>";
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"left\" width = \"40\%\">"+formatNumber(subAirfair1)+"</td>";         //"+fin_rate+"
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\">"+can_dollar+"</td>"; 
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\">"+formatNumber(subhotel1)+"</td>";
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\">"+can_dollar+"</td>";
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\">"+formatNumber(submeals1)+"</td>";
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\">"+can_dollar+"</td>";
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"21\%\">"+formatNumber(submisc1)+"</td>";
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"9\%\"><b>"+can_dollar+"</b></td>";
	strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"20\%\"><b>"+formatNumber(final_sub)+"</b></td>";
	strName += "</tr>";
}
...
{
	var final = parseFloat(subTOtal) + parseFloat(tax);
	var fin1 = final.toFixed(2);
...
if(tax_Subsidiary == 'AST LLC' || tax_Subsidiary == 'Serene AST LLC')
{
	...
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-left=\"0.2\" border-bottom=\"0.2\" width = \"30\%\" font-size=\"10\"><b>Total</b></td>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\"></td>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"right\" width = \"40\%\"></td>";        
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\"></td>"; 
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\"></td>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\"></td>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\"></td>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\"></td>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"right\" width = \"10\%\"><b>"+nlapiEscapeXML(ExpCurrency)+"</b></td>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\"></td>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"10\%\"><b>"+tot_fin1+"</b></td>";
	strName += "</tr>";
}
else if(tax_Subsidiary == 'Serene AST Australia')
{
	strName += "<tr margin-top=\"25px\">";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-left=\"0.2\" border-bottom=\"0.2\" width = \"10\%\" font-size=\"10\"><b>SubTotal</b></td>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\"></td>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"right\" width = \"10\%\"></td>";         
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\"></td>"; 
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"right\" width = \"10\%\"></td>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\"></td>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"right\" width = \"10\%\"></td>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\"></td>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"right\" width = \"10\%\"><b>"+nlapiEscapeXML(ExpCurrency)+"</b></td>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"right\"></td>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"10\%\"><b>"+formatNumber(parseFloat(EndTot).toFixed(2))+"</b></td>";
    strName += "</tr>";
								
	strName += "<tr>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-left=\"0.2\" border-bottom=\"0.2\" width = \"10\%\" font-size=\"10\"><b>Tax</b></td>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\"></td>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"right\" width = \"10\%\"></td>";        
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\"></td>"; 
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"right\" width = \"10\%\"></td>";
	...
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"right\" width = \"10\%\"><b>"+nlapiEscapeXML(ExpCurrency)+"</b></td>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"right\"></td>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"10\%\"><b>"+ItemTaxRate+"</b></td>";
	strName += "</tr>";
								
	var newValue = parseFloat(EndTot)+parseFloat(tax_taxSub_tot);
	strName += "<tr>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-left=\"0.2\" border-bottom=\"0.2\" width = \"10\%\" font-size=\"10\"><b>Total</b></td>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\"></td>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"right\" width = \"10\%\"></td>";        
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\"></td>"; 
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"right\" width = \"10\%\"></td>";
	...
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"right\" width = \"10\%\"><b>"+nlapiEscapeXML(ExpCurrency)+"</b></td>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"right\"></td>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"10\%\"><b>"+formatNumber(parseFloat(newValue).toFixed(2))+"</b></td>";
	strName += "</tr>";
	}
else
{
	...
	strName += "<tr>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-left=\"0.2\" border-bottom=\"0.2\" width = \"10\%\" font-size=\"10\"><b>GST/HST</b></td>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\"></td>";
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"right\" width = \"10\%\"></td>";        
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"10\%\"></td>"; 
	strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"right\" width = \"10\%\"></td>";
		...
		//*************************************DETAIL EXPENSE DETAIL**********************************
							...
							//**********************************Expense Table*********************************
								...
								if(expSearchResults)
								{
									...
									strName += "<table width=\"100\%\" table-layout = \"fixed\" font-family=\"Helvetica\"  >";
									strName += "<tr>";
									strName += "<td border-top=\"0.2\" table-layout = \"fixed\" width = \"32\%\" font-size=\"10\"><b>Consultant</b></td>";
									...
									if(expSearchResults != null && expSearchResults != '')
									{
										...
										{
											strName += "<tr>";
											strName += "<td border-top=\"0.2\" table-layout = \"fixed\" width = \"32\%\" font-size=\"10\" text-align=\"left\" style=\"white-space:nowrap;\">"+nlapiEscapeXML(expCounsaltantUniq[x])+"</td>";
											...
											for (var q = 0;  q < expSearchResults.length; q++) 
											{
										        ...
										        if(expCounsaltantUniq[x] == counsaltantName)
										        {
													...
													{
														strName += "<tr>";
														strName += "<td table-layout = \"fixed\" border-top=\"0.2\" width = \"32\%\" font-size=\"10\"></td>";
											...
											else
											{
												...
												strName += "<td border-top=\"0.2\" width = \"36\%\" font-size=\"10\"><b>Resource Expense SubTotal</b></td>";
												strName += "<td border-top=\"0.2\" width = \"15\%\" font-size=\"10\" align=\"right\"></td>";
												strName += "<td border-top=\"0.2\" width = \"15\%\" font-size=\"10\" align=\"left\"><b>"+can_dollar+"</b></td>";
												strName += "<td border-top=\"0.2\" width = \"23\%\" font-size=\"10\" align=\"right\"><b>"+final_expTotal+"</b></td>";
												strName += "</tr>";	
											}
										}//End of for (var x = 0;  x < expCounsaltantUniq.length; x++) 
								...
								else
								{
									...
									strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"36\%\" font-size=\"10\"><b>Expense SubTotal</b></td>";
									strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"15\%\" font-size=\"10\"></td>";
									strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"15\%\" font-size=\"10\" align=\"left\"><b>"+can_dollar+"</b></td>";
									strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"23\%\" font-size=\"10\" align=\"right\"><b>"+final_expresourceTotal1+"</b></td>";
									strName += "</tr>";
								}
									...
									if(tax_Subsidiary == 'AST LLC' || tax_Subsidiary == 'Serene AST LLC')
									{
											...
											strName += "<tr margin-top=\"25px\">";
											strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" table-layout = \"fixed\" width = \"26\%\" font-size=\"10\"><b>Expense Total</b></td>";
											strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" table-layout = \"fixed\" width = \"28\%\" font-size=\"10\"></td>";
											strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" table-layout = \"fixed\" width = \"25\%\" font-size=\"10\"></td>";
											strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" table-layout = \"fixed\" width = \"15\%\" font-size=\"10\"></td>";
											...
											var finTotalForBoth =parseFloat(tot_grand_total)+parseFloat(resourceTotal);
											strName += "<tr>";
											strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" table-layout = \"fixed\" width = \"26\%\" font-size=\"10\"><b>Total</b></td>";
											strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" table-layout = \"fixed\" width = \"28\%\" font-size=\"10\"></td>";
											strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" table-layout = \"fixed\" width = \"25\%\" font-size=\"10\"></td>";
									...
									{
											strName += "<tr margin-top=\"25px\">";
											strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"26\%\" font-size=\"10\"><b>SubTotal</b></td>";
											strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"28\%\" font-size=\"10\"></td>";
											strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"25\%\" font-size=\"10\" align=\"left\"></td>";
											strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"15\%\" font-size=\"10\" align=\"left\"></td>";
											strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"15\%\" font-size=\"10\" align=\"left\"><b>"+nlapiEscapeXML(ExpCurrency)+"</b></td>";
											...
											strName += "<tr>";
											strName += "<td border-bottom=\"0.2\"  table-layout = \"fixed\" width = \"26\%\" font-size=\"10\"><b>Tax</b></td>";
											strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"28\%\" font-size=\"10\"></td>";
											strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"25\%\" font-size=\"10\"></td>";
											strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"15\%\" font-size=\"10\" align=\"right\"></td>";
											strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"15\%\" font-size=\"10\" align=\"left\"><b>"+nlapiEscapeXML(ExpCurrency)+"</b></td>";
											strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"23\%\" font-size=\"10\" align=\"right\"><b>"+ItemTaxRate+"</b></td>";
											strName += "</tr>";
														
											var secPage = parseFloat(EndTot)+ parseFloat(tax);
											strName += "<tr>";
											strName += "<td border-bottom=\"0.2\"  table-layout = \"fixed\" width = \"26\%\" font-size=\"10\"><b>Total</b></td>";
											strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"28\%\" font-size=\"10\"></td>";
											strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"25\%\" font-size=\"10\"></td>";
											strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"15\%\" font-size=\"10\" align=\"right\"></td>";
											strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"15\%\" font-size=\"10\" align=\"left\"><b>"+nlapiEscapeXML(ExpCurrency)+"</b></td>";
											...
											strName += "<td table-layout = \"fixed\" width = \"25\%\" font-size=\"10\"><b>Total payments to date</b></td>";
											strName += "<td table-layout = \"fixed\" width = \"15\%\" font-size=\"10\" align=\"right\"></td>";
											strName += "<td table-layout = \"fixed\" width = \"15\%\" font-size=\"10\" align=\"left\"><b>"+nlapiEscapeXML(ExpCurrency)+"</b></td>";
											strName += "<td table-layout = \"fixed\" width = \"23\%\" font-size=\"10\" align=\"right\"><b>"+formatNumber(parseFloat(AmtPaid).toFixed(2))+"</b></td>";
											strName += "</tr>";
											...
											strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" table-layout = \"fixed\" width = \"25\%\" font-size=\"10\"><b>Balance Due</b></td>";
											strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" table-layout = \"fixed\" width = \"15\%\" font-size=\"10\" align=\"right\"></td>";
											strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" table-layout = \"fixed\" width = \"15\%\" font-size=\"10\" align=\"left\"><b>"+nlapiEscapeXML(ExpCurrency)+"</b></td>";
											strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" table-layout = \"fixed\" width = \"23\%\" font-size=\"10\" align=\"right\"><b>"+formatNumber(parseFloat(AmtDue).toFixed(2))+"</b></td>";
											strName += "</tr>";*/
									}
									else
									{
										...
										strName += "<tr>";
										strName += "<td border-bottom=\"0.2\"  table-layout = \"fixed\" width = \"26\%\" font-size=\"10\"><b>GST/HST</b></td>";
										strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"28\%\" font-size=\"10\"></td>";
										strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"25\%\" font-size=\"10\"></td>";
										strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"15\%\" font-size=\"10\" align=\"right\"></td>";
										strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"15\%\" font-size=\"10\" align=\"left\"><b>"+nlapiEscapeXML(ExpCurrency)+"</b></td>";

					...
					function suiteletInvoiceLayout(request, response)
					{
							...
							res_Proj ='';
								...
								if(tax_Subsidiary == 'AST LLC' || tax_Subsidiary == 'Serene AST LLC')
								{
									if(billcontName == '')
									{
										...
										strName += "<tr>";
										strName += "<td border-top=\"0.2\" width = \"53\%\"  align=\"left\" font-size=\"10\" table-layout = \"fixed\" ><b>Invoice&nbsp;</b>#:&nbsp;"+Invoice_no+"<br/><b>Date:&nbsp;</b>"+Time_period+"<br/><b>Terms:&nbsp;</b>"+terms+"<br/><b>Due:&nbsp;</b>"+due+"<br/><b>Project:</b>"+nlapiEscapeXML(res_Proj)+"<br/><b>Customer PO#:&nbsp;</b>"+nlapiEscapeXML(po_no)+"<br/></td>";
										strName += "<td border-top=\"0.2\" width = \"10\%\"  align=\"left\" font-size=\"10\" table-layout = \"fixed\" ></td>";
										strName += "<td border-top=\"0.2\" width = \"45\%\"  align=\"right\" font-size=\"10\" table-layout = \"fixed\" ><b>To</b><br/>"+nlapiEscapeXML(address)+"<br/>"+nlapiEscapeXML(addressText1)+"&nbsp;"+nlapiEscapeXML(addressText2)+"<br/>"+nlapiEscapeXML(city)+"<br/>"+nlapiEscapeXML(country)+"&nbsp;"+zip+"</td>";
										strName += "<td border-top=\"0.2\" width = \"5\%\"  align=\"left\" font-size=\"10\" table-layout = \"fixed\" ></td>";
										strName += "<td border-top=\"0.2\" width = \"65\%\"  align=\"right\" font-size=\"10\" table-layout = \"fixed\" ><b>From</b><br/>"+nlapiEscapeXML(sub_address)+"<br/>"+nlapiEscapeXML(sub_addressText1)+"&nbsp;"+nlapiEscapeXML(sub_addressText2)+"<br/>"+nlapiEscapeXML(sub_city)+"&nbsp;"+nlapiEscapeXML(sub_country)+"&nbsp;"+sub_zip+"<br/>Email: ar@astcorporation.com<br/>Fax:"+fax+"<br/>Phone: +1 (630) 778-1180 </td>";
										strName += "</tr>";	
										strName += "</table ><br/>";
									}
									else{
								...
								strName += "<td border-top=\"0.2\" width = \"53\%\"  align=\"left\" font-size=\"10\" table-layout = \"fixed\" ><b>Invoice&nbsp;</b>#:&nbsp;"+Invoice_no+"<br/><b>Date:&nbsp;</b>"+Time_period+"<br/><b>Terms:&nbsp;</b>"+terms+"<br/><b>Due:&nbsp;</b>"+due+"<br/><b>Project:</b>"+nlapiEscapeXML(res_Proj)+"<br/><b>Customer PO#:&nbsp;</b>"+nlapiEscapeXML(po_no)+"<br/></td>";
								strName += "<td border-top=\"0.2\" width = \"10\%\"  align=\"left\" font-size=\"10\" table-layout = \"fixed\" ></td>";
								strName += "<td border-top=\"0.2\" width = \"45\%\"  align=\"right\" font-size=\"10\" table-layout = \"fixed\" ><b>To</b><br/>"+nlapiEscapeXML(billcontName)+"<br/>"+nlapiEscapeXML(address)+"<br/>"+nlapiEscapeXML(addressText1)+"&nbsp;"+nlapiEscapeXML(addressText2)+"<br/>"+nlapiEscapeXML(city)+"<br/>"+nlapiEscapeXML(country)+"&nbsp;"+zip+"</td>";
								strName += "<td border-top=\"0.2\" width = \"5\%\"  align=\"left\" font-size=\"10\" table-layout = \"fixed\" ></td>";
								strName += "<td border-top=\"0.2\" width = \"65\%\"  align=\"right\" font-size=\"10\" table-layout = \"fixed\" ><b>From</b><br/>"+nlapiEscapeXML(sub_address)+"<br/>"+nlapiEscapeXML(sub_addressText1)+"&nbsp;"+nlapiEscapeXML(sub_addressText2)+"<br/>"+nlapiEscapeXML(sub_city)+"&nbsp;"+nlapiEscapeXML(sub_country)+"&nbsp;"+sub_zip+"<br/>Email: ar@astcorporation.com<br/>Fax:"+fax+"<br/>Phone: +1 (630) 778-1180 </td>";
								strName += "</tr>";	
								strName += "</table ><br/>";
								...
								else
								{
									...
									strName += "<td border-top=\"0.2\" width = \"45\%\"  align=\"right\" font-size=\"10\" table-layout = \"fixed\" ><b>To</b><br/>"+nlapiEscapeXML(billcontName)+"<br/>"+nlapiEscapeXML(address)+"<br/>"+nlapiEscapeXML(addressText1)+"&nbsp;"+nlapiEscapeXML(addressText2)+"<br/>"+nlapiEscapeXML(city)+"<br/>"+nlapiEscapeXML(country)+"&nbsp;"+zip+"</td>";
									strName += "<td border-top=\"0.2\" width = \"5\%\"  align=\"left\" font-size=\"10\" table-layout = \"fixed\" ></td>";
									strName += "<td border-top=\"0.2\" width = \"65\%\"  align=\"right\" font-size=\"10\" table-layout = \"fixed\" ><b>From</b><br/>"+nlapiEscapeXML(sub_address)+"<br/>"+nlapiEscapeXML(sub_addressText1)+"&nbsp;"+nlapiEscapeXML(sub_addressText2)+"<br/>"+nlapiEscapeXML(sub_city)+"&nbsp;"+nlapiEscapeXML(sub_country)+"&nbsp;"+sub_zip+"<br/>Email: ar@astcorporation.com<br/>Fax: +1 (630) 778-1179 <br/>GST/HST#: 741870323RT0001<br/>Phone: 647-478-0177 </td>";
									strName += "</tr>";	
									strName += "</table ><br/>";
									}
								}	
						...
						//***************************Time Entries Table************************************
								...
								if(searchResults)
								{
									...
									strName += "<table width=\"100\%\" table-layout = \"fixed\" font-family=\"Helvetica\"  >";
									strName += "<tr>";
									strName += "<td table-layout = \"fixed\" border-right=\"0.2\" border-left=\"0.2\" border-top=\"0.2\" border-bottom=\"0.2\" width = \"40\%\" font-size=\"10\"><b>Resource Name</b></td>";
									...
									strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" font-size=\"10\" align=\"right\" width = \"8\%\"></td>";
									strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" font-size=\"10\" align=\"left\" width = \"8\%\"></td>";
									strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"24\%\"><b>Total Hours</b></td>";
									strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" font-size=\"10\" align=\"right\" width = \"12\%\"></td>";
									strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"21\%\"><b>Hourly Rate</b></td>";
									strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" font-size=\"10\" align=\"right\" width = \"12\%\"></td>";
									strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"25\%\"> <b>Total Dollars</b></td>";
									strName += "</tr>";
									...
									if (searchResults != null && searchResults != '')
									{
										...
										for (var m = 0;  m < counsaltantUniq1.length; m++) 
										{
											for (var k = 0;  k < searchResults.length; k++) 
											{
												...
												if(counsaltantUniq1[m] == counsaltant1)
												{
													...
													strName += "<tr>";
													strName += "<td table-layout = \"fixed\" border-right=\"0.2\" border-left=\"0.2\" border-top=\"0.2\" border-bottom=\"0.2\" width = \"40\%\" font-size=\"10\">"+nlapiEscapeXML(counsaltantUniq1[m])+"</td>";
													strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" font-size=\"10\" align=\"left\" width = \"8\%\"></td>";
													strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" font-size=\"10\" align=\"right\" width = \"8\%\"></td>";        
													strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" font-size=\"10\" align=\"left\" width = \"8\%\"></td>"; 
													...
													strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"20\%\">"+parseFloat(oaHours).toFixed(1)+"</td>";
													strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" font-size=\"10\" align=\"right\" width = \"12\%\">"+nlapiEscapeXML(currency1)+"</td>";
													strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"21\%\">"+fin_rate+"</td>";
													strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" font-size=\"10\" align=\"right\" width = \"12\%\">"+nlapiEscapeXML(currency1)+"</td>";
													strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"25\%\">"+fin_new_Totdollar+"</td>";
													strName += "</tr>";
										...
										strName += "<tr>";
										strName += "<td table-layout = \"fixed\" border-right=\"0.2\" border-left=\"0.2\" border-top=\"0.2\" border-bottom=\"0.2\" width = \"40\%\" font-size=\"10\"><b>Time SubTotal</b></td>";
										strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" font-size=\"10\" align=\"left\" width = \"8\%\"></td>";
										strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" font-size=\"10\" align=\"right\" width = \"8\%\"></td>";        
										strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" font-size=\"10\" align=\"left\" width = \"8\%\"></td>"; 
										strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\"></td>";
										strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" font-size=\"10\" align=\"left\" width = \"15\%\"></td>";
										strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"20\%\">"+total_hours1+"</td>";
										strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" font-size=\"10\" align=\"right\" width = \"12\%\"></td>";
										strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"21\%\"></td>";
										strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" font-size=\"10\" align=\"right\" width = \"12\%\"><b>"+nlapiEscapeXML(currency1)+"</b></td>";
										strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"25\%\"><b>"+fin_total_dollar1+"</b></td>";
										strName += "</tr>";
									}//End of if looop
				...
				//**********************************Expense Table*********************************
					...
					else if(tax_Subsidiary == 'AST LLC' || tax_Subsidiary == 'Serene AST LLC')
					{
						...
						strName += "<tr>";
						strName += "<td table-layout = \"fixed\" border-right=\"0.2\" border-left=\"0.2\" border-bottom=\"0.2\" width = \"25\%\" font-size=\"10\"><b>Total</b></td>";
						...
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" width = \"13\%\" font-size=\"10\" align=\"left\"><b>"+nlapiEscapeXML(currency1)+"</b></td>";
						strName += "<td table-layout = \"fixed\" border-right=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" width = \"10\%\" align=\"right\"><b>"+tot_fin123+"</b></td>";
						strName += "</tr>";
						strName += "</table>";
					}
					else 
					{
						...
						strName += "<table width=\"100\%\" font-family=\"Helvetica\" border-top=\"0.2\">";
						strName += "<tr>";
						strName += "<td table-layout = \"fixed\" border-right=\"0.2\" border-left=\"0.2\" border-bottom=\"0.2\" width = \"25\%\" font-size=\"10\"><b>SubTotal</b></td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" width = \"20\%\" font-size=\"10\" align=\"right\"></td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\"></td>";        
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" width = \"25\%\" align=\"right\"></td>"; 
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" width = \"13\%\" font-size=\"10\" align=\"left\"><b>"+nlapiEscapeXML(currency1)+"</b></td>";
						strName += "<td table-layout = \"fixed\" border-right=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" width = \"10\%\" align=\"right\"><b>"+fin_total_dollar1+"</b></td>";
						strName += "</tr>";
						
						strName += "<tr>";
						strName += "<td table-layout = \"fixed\" border-right=\"0.2\" border-left=\"0.2\" border-bottom=\"0.2\" width = \"25\%\" font-size=\"10\"><b>Tax</b></td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" width = \"20\%\" font-size=\"10\" align=\"right\"></td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\"></td>";        
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" width = \"25\%\" align=\"right\"></td>"; 
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" width = \"13\%\" font-size=\"10\" align=\"left\"><b>"+nlapiEscapeXML(currency1)+"</b></td>";
						strName += "<td table-layout = \"fixed\" border-right=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" width = \"10\%\" align=\"right\"><b>"+final_tax_taxSub_tot+"</b></td>";
						strName += "</tr>";
				...
				//**********************************Expense Table*********************************
					...
					if(expSearchResults)
					{
						...
						strName += "<table width=\"100\%\" table-layout = \"fixed\" font-family=\"Helvetica\"  >";
						strName += "<tr>";
						strName += "<td table-layout = \"fixed\" border-right=\"0.2\" border-left=\"0.2\" border-top=\"0.2\" border-bottom=\"0.2\" width = \"25\%\" font-size=\"10\"><b>Resource Name</b></td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" font-size=\"10\" align=\"left\" width = \"12\%\"></td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\"><b>Airfare</b></td>";        
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" font-size=\"10\" align=\"left\" width = \"12\%\"></td>"; 
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\"><b>Hotel</b></td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" font-size=\"10\" align=\"left\" width = \"12\%\"></td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\"><b>Meals</b></td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" font-size=\"10\" align=\"right\" width = \"12\%\"></td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"21\%\"><b>Miscellaneous</b></td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" font-size=\"10\" align=\"right\" width = \"12\%\"></td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-top=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"25\%\"><b>Expense SubTotal</b></td>";
						strName += "</tr>";
							...
							for (var x = 0;  x < expCounsaltantUniq.length; x++) 
							{
								for (var q = 0;  q < expSearchResults.length; q++) 
								{
							        ...
							        if(expCounsaltantUniq[x] == counsaltantName)
							        {
										...
										strName += "<tr>";
										strName += "<td table-layout = \"fixed\" border-right=\"0.2\" border-left=\"0.2\" border-bottom=\"0.2\" width = \"25\%\" font-size=\"10\">"+nlapiEscapeXML(expCounsaltantUniq[x])+"</td>";
										strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"15\%\">"+nlapiEscapeXML(ExpCurrency)+"</td>";
										strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\">"+airFair+"</td>";         //"+fin_rate+"
										strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"15\%\">"+nlapiEscapeXML(ExpCurrency)+"</td>"; 
										strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\">"+hotel+"</td>";
										strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"15\%\">"+nlapiEscapeXML(ExpCurrency)+"</td>";
										strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\">"+meals+" </td>";
										strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"15\%\">"+nlapiEscapeXML(ExpCurrency)+"</td>";
										strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"19\%\">"+miscellaneous+"</td>";
										strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"15\%\">"+nlapiEscapeXML(ExpCurrency)+"</td>";
										strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"23\%\">"+final_ExpType_total+"</td>";
										strName += "</tr>";
						...
						strName += "<tr>";
						strName += "<td table-layout = \"fixed\" border-right=\"0.2\" border-left=\"0.2\" border-bottom=\"0.2\" width = \"25\%\" font-size=\"10\"><b>Expense SubTotal</b></td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"15\%\">"+nlapiEscapeXML(ExpCurrency)+"</td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\">"+subAirfair1+"</td>";         //"+fin_rate+"
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"15\%\">"+nlapiEscapeXML(ExpCurrency)+"</td>"; 
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\">"+subhotel1+"</td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"15\%\">"+nlapiEscapeXML(ExpCurrency)+"</td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\">"+submeals1+"</td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"15\%\">"+nlapiEscapeXML(ExpCurrency)+"</td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"19\%\">"+submisc1+"</td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"15\%\"><b>"+nlapiEscapeXML(ExpCurrency)+"</b></td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"23\%\"><b>"+final_sub+"</b></td>";
						strName += "</tr>";
						...
						if(tax_Subsidiary == 'AST LLC' || tax_Subsidiary == 'Serene AST LLC')
						{
							...
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-right=\"0.2\" border-left=\"0.2\" border-bottom=\"0.2\" width = \"25\%\" font-size=\"10\"><b>Total</b></td>";
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"15\%\"></td>";
							...
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\"></td>";
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"15\%\"></td>";
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"19\%\"></td>";
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"15\%\"><b>"+nlapiEscapeXML(ExpCurrency)+"</b></td>";
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"23\%\"><b>"+tot_fin1+"</b></td>";
							strName += "</tr>";
						}
						else
						{
							...
							strName += "<tr margin-top=\"25px\">";
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-right=\"0.2\" border-left=\"0.2\" border-bottom=\"0.2\" width = \"25\%\" font-size=\"10\"><b>SubTotal</b></td>";
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"15\%\"></td>";
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\"></td>";         
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"15\%\"></td>"; 
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\"></td>";
							...
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"19\%\"></td>";
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"15\%\"><b>"+nlapiEscapeXML(ExpCurrency)+"</b></td>";
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"23\%\"><b>"+final_fin+"</b></td>";
							strName += "</tr>";
							
							
							strName += "<tr>";
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-right=\"0.2\" border-left=\"0.2\" border-bottom=\"0.2\" width = \"25\%\" font-size=\"10\"><b>Tax</b></td>";
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"15\%\"></td>";
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\"></td>";        
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"15\%\"></td>"; 
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"right\" width = \"15\%\"></td>";
							...
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"19\%\"></td>";
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" font-size=\"10\" align=\"left\" width = \"15\%\"><b>"+nlapiEscapeXML(ExpCurrency)+"</b></td>";
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" border-right=\"0.2\" font-size=\"10\" align=\"right\" width = \"23\%\"><b>"+final_tax_taxSub_tot+"</b></td>";
							strName += "</tr>";
		...
		//*******************************DETAIL TIME AND EXPENCE TABLE ENTRY*************************************
						...
						if(searchResults)
						{
							...
							strName += "<table width=\"100\%\" table-layout = \"fixed\" font-family=\"Helvetica\"  >";
							strName += "<tr>";
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" width = \"30\%\" font-size=\"10\"><b>Consultant</b></td>";
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" width = \"33\%\" font-size=\"10\" align=\"left\"><b>Time Period</b></td>";
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" width = \"34\%\" font-size=\"10\"><b>Task</b></td>";
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" width = \"17.7\%\" font-size=\"10\" align=\"right\"><b>Hours</b></td>";
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" width = \"25\%\" font-size=\"10\" align=\"right\"><b>Rate</b></td>";
							strName += "<td table-layout = \"fixed\" border-top=\"0.2\" border-bottom=\"0.2\" width = \"26\%\" font-size=\"10\" align=\"right\"><b>Total</b></td>";
							strName += "</tr>";
							...
							if (searchResults != null && searchResults != '')
							{
								...
								for (var m = 0;  m < counsaltantUniq1.length; m++) 
								{
									...
									strName += "<tr>";
									strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" width = \"30\%\" font-size=\"10\" align=\"left\">"+nlapiEscapeXML(counsaltantUniq1[m])+"</td>";
									strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" width = \"33\%\" font-size=\"10\"></td>";
									strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" width = \"34\%\" font-size=\"10\"></td>";
									strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" width = \"17.7\%\" font-size=\"10\"></td>";
									strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" width = \"25\%\" font-size=\"10\"></td>";
									...
									for (var k = 0;  k < searchResults.length; k++) 
									{
										...
										if(counsaltantUniq1[m] == counsaltant1)
								        {
									       ...
									       // nlapiLogExecution('DEBUG','Log in TimeSheet','hourSumGlob TimeSheet ='+hourSumGlob);
											...
											{
												strName += "<tr>";
												strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" width = \"30\%\" font-size=\"10\"></td>";
												strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" width = \"33\%\" font-size=\"10\" align=\"left\">"+value1+"</td>";
												strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" width = \"34\%\" font-size=\"10\">"+nlapiEscapeXML(task1)+"</td>";
												strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" width = \"17.7\%\" font-size=\"10\" align=\"right\">"+parseFloat(hourSum1).toFixed(1)+"</td>";
												strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" width = \"25\%\" font-size=\"10\" align=\"right\">"+nlapiEscapeXML(currency1)+"&nbsp;"+final_rate+"/hr</td>";
												strName += "<td table-layout = \"fixed\" border-bottom=\"0.2\" width = \"26\%\" font-size=\"10\" align=\"right\">"+nlapiEscapeXML(currency1)+"&nbsp;"+final_totalAmount1+"</td>";
												strName += "</tr>";		
											}
											else
											{
									...
									{
										strName += "<tr>";
										strName += "<td border-bottom=\"0.2\" width = \"30\%\" font-size=\"10\"></td>";
										strName += "<td border-bottom=\"0.2\" width = \"33\%\" font-size=\"10\"></td>";
										strName += "<td border-bottom=\"0.2\" width = \"34\%\" font-size=\"10\"><b>Resource Time SubTotal</b></td>";
										strName += "<td border-bottom=\"0.2\" width = \"17.7\%\" font-size=\"10\" align=\"right\"><b>"+parseFloat(hourSumGlob).toFixed(1)+"</b></td>";
										strName += "<td border-bottom=\"0.2\" width = \"25\%\" font-size=\"10\"></td>";
										strName += "<td border-bottom=\"0.2\" width = \"26\%\" font-size=\"10\" align=\"right\"><b>"+nlapiEscapeXML(currency1)+"&nbsp;"+final_resourceTotal1+"</b></td>";
										strName += "</tr>";
									}
									if(tax_Subsidiary != 'AST LLC')
										{
					...
					{	
						...
						strName += "<td border-bottom=\"0.2\" width = \"30\%\" font-size=\"10\"></td>";
						strName += "<td border-bottom=\"0.2\" width = \"33\%\" font-size=\"10\"></td>";
						strName += "<td border-bottom=\"0.2\" width = \"34\%\" font-size=\"10\"><b>Time SubTotal</b></td>";
						strName += "<td border-bottom=\"0.2\" width = \"17.7\%\" font-size=\"10\" align=\"right\"><b>"+parseFloat(subhourSum1).toFixed(1)+"</b></td>";
						strName += "<td border-bottom=\"0.2\" width = \"25\%\" font-size=\"10\"></td>";
						strName += "<td border-bottom=\"0.2\" width = \"26\%\" font-size=\"10\" align=\"right\"><b>"+nlapiEscapeXML(currency1)+"&nbsp;"+final_subresourceTotal1+"</b></td>";
						strName += "</tr>";	
					}
					else
					{
		...
		//*************************************DETAIL EXPENSE DETAIL**********************************
				...
				else if(tax_Subsidiary == 'AST LLC' || tax_Subsidiary == 'Serene AST LLC')
				{
					if(tax_Subsidiary == 'AST LLC' || tax_Subsidiary == 'Serene AST LLC')
					{
						...
						strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"19\%\" font-size=\"10\" align=\"right\"><b>"+nlapiEscapeXML(currency1)+"&nbsp;"+final_fin32+"</b></td>";
						strName += "</tr>";									
						strName += "</table>";
					}
					else
				...
				else
				{
					...
					if(tax_Subsidiary == 'AST LLC' || tax_Subsidiary == 'Serene AST LLC')
					{
						...
						strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"15\%\" font-size=\"10\" align=\"right\">	</td>";
						strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"15\%\" font-size=\"10\"></td>";
						strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"19\%\" font-size=\"10\" align=\"right\"><b>"+nlapiEscapeXML(currency1)+"&nbsp;"+final_subresourceTotal1+"</b></td>";
						strName += "</tr>";
									    
						strName += "<tr>";
						strName += "<td border-bottom=\"0.2\" width = \"25\%\" font-size=\"10\"></td>";
						strName += "<td border-bottom=\"0.2\" width = \"32\%\" font-size=\"10\"></td>";
						strName += "<td border-bottom=\"0.2\" width = \"30\%\" font-size=\"10\" align=\"letf\"><b>Tax</b></td>";
						strName += "<td border-bottom=\"0.2\" width = \"15\%\" font-size=\"10\" align=\"right\"></td>";
						strName += "<td border-bottom=\"0.2\" width = \"15\%\" font-size=\"10\"></td>";
						strName += "<td border-bottom=\"0.2\" width = \"19\%\" font-size=\"10\" align=\"right\"><b>"+nlapiEscapeXML(currency1)+"&nbsp;"+parseFloat(tax_taxSub_tot).toFixed(2)+"</b></td>";
						strName += "</tr>";
						...
						strName += "<td border-bottom=\"0.2\" width = \"15\%\" font-size=\"10\" align=\"right\"></td>";
						strName += "<td border-bottom=\"0.2\" width = \"15\%\" font-size=\"10\"></td>";
						strName += "<td border-bottom=\"0.2\" width = \"19\%\" font-size=\"10\" align=\"right\"><b>"+nlapiEscapeXML(currency1)+"&nbsp;"+final_fin32+"</b></td>";
						strName += "</tr>";								
						strName += "</table>";
					}
					else
				...
				//**********************************Expense Table*********************************
					...
					if(expSearchResults)
					{
						...
						strName += "<table width=\"100\%\" table-layout = \"fixed\" font-family=\"Helvetica\"  >";
						strName += "<tr>";
						strName += "<td border-top=\"0.2\" table-layout = \"fixed\" width = \"24\%\" font-size=\"10\"><b>Consultant</b></td>";
						strName += "<td border-top=\"0.2\" table-layout = \"fixed\" width = \"30\%\" font-size=\"10\" align=\"left\"><b>Time Period</b></td>";
						strName += "<td border-top=\"0.2\" table-layout = \"fixed\" width = \"35\%\" font-size=\"10\" align=\"left\"><b>Expense Type</b></td>";
						...
						if(expSearchResults != null && expSearchResults != '')
						{
							...
							{
								strName += "<tr>";
								strName += "<td border-top=\"0.2\" table-layout = \"fixed\" width = \"24\%\" font-size=\"10\">"+nlapiEscapeXML(expCounsaltantUniq[x])+"</td>";
								strName += "<td border-top=\"0.2\" table-layout = \"fixed\" width = \"30\%\" font-size=\"10\"></td>";
								...
								for (var q = 0;  q < expSearchResults.length; q++) 
								{
							        ...
							        if(expCounsaltantUniq[x] == counsaltantName)
							        {
										...
										{	
											strName += "<tr>";
											strName += "<td table-layout = \"fixed\" border-top=\"0.2\" width = \"24\%\" font-size=\"10\"></td>";
											strName += "<td table-layout = \"fixed\" border-top=\"0.2\" width = \"30\%\" font-size=\"10\" align=\"left\">"+value1+"</td>";
											strName += "<td table-layout = \"fixed\" border-top=\"0.2\" width = \"35\%\" font-size=\"10\" align=\"left\">"+nlapiEscapeXML(ExpenseType)+"</td>";
											strName += "<td table-layout = \"fixed\" border-top=\"0.2\" width = \"15\%\" font-size=\"10\" align=\"right\"></td>";
											strName += "<td table-layout = \"fixed\" border-top=\"0.2\" width = \"15\%\" font-size=\"10\" align=\"right\"></td>";
											strName += "<td table-layout = \"fixed\" border-top=\"0.2\" width = \"23\%\" font-size=\"10\" align=\"right\">"+nlapiEscapeXML(ExpCurrency)+"&nbsp;"+final_amount+"</td>";
											strName += "</tr>";
										}
										else
										{
								...
								{
									strName += "<tr>";
									strName += "<td border-top=\"0.2\" width = \"24\%\" font-size=\"10\"></td>";
									strName += "<td border-top=\"0.2\" width = \"30\%\" font-size=\"10\"></td>";
									strName += "<td border-top=\"0.2\" width = \"35\%\" font-size=\"10\"><b>Resource Expense SubTotal</b></td>";
									strName += "<td border-top=\"0.2\" width = \"15\%\" font-size=\"10\" align=\"right\"></td>";
									strName += "<td border-top=\"0.2\" width = \"15\%\" font-size=\"10\"></td>";
									strName += "<td border-top=\"0.2\" width = \"23\%\" font-size=\"10\" align=\"right\"><b>"+nlapiEscapeXML(ExpCurrency)+"&nbsp;"+final_expTotal+"</b></td>";
									strName += "</tr>";	
								}
								else
								{
					...
					{
						strName += "<tr>";
						strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"24\%\" font-size=\"10\"></td>";
						strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"30\%\" font-size=\"10\"></td>";
						strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"35\%\" font-size=\"10\"><b>Expense SubTotal</b></td>";
						strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"15\%\" font-size=\"10\" align=\"right\"></td>";
						strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"15\%\" font-size=\"10\"></td>";
						strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"23\%\" font-size=\"10\" align=\"right\"><b>"+nlapiEscapeXML(ExpCurrency)+"&nbsp;"+final_expresourceTotal1+"</b></td>";
						strName += "</tr>";
					}
					else
					{
						...
						if(tax_Subsidiary == 'AST LLC')
						{
							...
							{
								strName += "<tr margin-top=\"25px\">";
								strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" table-layout = \"fixed\" width = \"23\%\" font-size=\"10\"></td>";
								...
								strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" table-layout = \"fixed\" width = \"15\%\" font-size=\"10\" align=\"right\"></td>";
								strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" table-layout = \"fixed\" width = \"23\%\" font-size=\"10\" align=\"right\"><b>"+nlapiEscapeXML(ExpCurrency)+"&nbsp;"+final_grand_total+"</b></td>";
								strName += "</tr>";
							}
							else
							{
						...
						else
						{
							...
							{
								strName += "<tr margin-top=\"25px\">";
								strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"23\%\" font-size=\"10\"></td>";
								strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"28\%\" font-size=\"10\"></td>";
								...
								strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"15\%\" font-size=\"10\"></td>";
								strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"23\%\" font-size=\"10\" align=\"right\"><b>"+nlapiEscapeXML(ExpCurrency)+"&nbsp;"+final_total_tot+"</b></td>";
								strName += "</tr>";
													
								strName += "<tr>";
								strName += "<td border-bottom=\"0.2\"  table-layout = \"fixed\" width = \"23\%\" font-size=\"10\"></td>";
								...
								strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"15\%\" font-size=\"10\" align=\"right\"></td>";
								strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"23\%\" font-size=\"10\" align=\"right\"><b>"+nlapiEscapeXML(ExpCurrency)+"&nbsp;"+final_tax_taxSub_tot+"</b></td>";
								strName += "</tr>";
								...
								strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"15\%\" font-size=\"10\" align=\"right\"></td>";
								strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"15\%\" font-size=\"10\" align=\"right\"></td>";
								strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"23\%\" font-size=\"10\" align=\"right\"><b>"+nlapiEscapeXML(ExpCurrency)+"&nbsp;"+final_grand_total+"</b></td>";
								strName += "</tr>";	
							}
							else
							{
					...
					strName += "</table><br/>";
							...
							strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"15\%\" font-size=\"10\" align=\"left\"></td>";
							strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"15\%\" font-size=\"10\"></td>";
							strName += "<td border-top=\"0.2\" border-bottom=\"0.2\" width = \"19\%\" font-size=\"10\" align=\"right\"><b>"+ExpCurrency+""+dollar+"&nbsp;"+total_tot+"</b></td>";
							strName += "</tr>";
							...
							strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"15\%\" font-size=\"10\" align=\"right\"></td>";
							strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"15\%\" font-size=\"10\" align=\"right\"></td>";
							strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"19\%\" font-size=\"10\" align=\"right\"><b>"+ExpCurrency+""+dollar+"&nbsp;"+tax_taxSub_tot+"</b></td>";
							strName += "</tr>";
							...
							strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"15\%\" font-size=\"10\" align=\"right\"></td>";
							strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"15\%\" font-size=\"10\" align=\"right\"></td>";
							strName += "<td border-bottom=\"0.2\" table-layout = \"fixed\" width = \"19\%\" font-size=\"10\" align=\"right\"><b>"+ExpCurrency+""+dollar+"&nbsp;"+final_grand_total+"</b></td>";
							strName += "</tr>";
							strName += "</table><br/>";*/
				...
				//**********************Footer Part*****************************
					...
					strName += "<td width = \"40\%\" font-size=\"10\" align=\"left\">For Wire Payments:</td>";
					strName += "</tr>";
					
					strName += "<tr margin-top=\"15px\">";
					strName += "<td width = \"40\%\" font-size=\"10\" align=\"left\">Receiving Bank:<br/>Bank of Montreal<br/>International Banking, Head Office<br/>Montreal<br/>S.W.I.F.T BIC Code: BOFMCAM2</td>";
					strName += "</tr>";
					
					
					strName += "<tr margin-top=\"15px\">";
					strName += "<td width = \"40\%\" font-size=\"10\" align=\"left\">Beneficiary’s Bank:<br/>Bank of Montreal<br/>100 King St. West<br/>Toronto, ON M5X 1A3</td>";
					strName += "</tr>";
					
					strName += "<tr margin-top=\"15px\">";
					strName += "<td width = \"40\%\" font-size=\"10\" align=\"left\">Beneficiary’s Account #: 00021804657**</td>";
					strName += "</tr>";
					
					strName += "<tr margin-top=\"15px\">";
					strName += "<td width = \"40\%\" font-size=\"10\" align=\"left\">Beneficiary’s Address:<br/>AST Canada Corporation<br/>115 Matheson BLVD W., Unit 116<br/>Mississauga, ON<br/>L5R 3L1</td>";
					strName += "</tr>";
					
					strName += "<tr margin-top=\"15px\">";
					strName += "<td width = \"40\%\" font-size=\"10\" align=\"left\">For EFT Payments:<br/>Account Name: AST Canada Corporation<br/>Transit &amp; Inst. #: 00022-001<br/>Account #: 1804657</td>";
					strName += "</tr>";
					
					strName += "<tr margin-top=\"15px\">";
					strName += "<td width = \"40\%\" font-size=\"10\" align=\"left\">Branch Address:<br/>Bank of Montreal<br/>100 King Street West<br/>Toronto ON<br/>M5X1A3</td>";
					strName += "</tr>";
					strName += "</table>";	
					}

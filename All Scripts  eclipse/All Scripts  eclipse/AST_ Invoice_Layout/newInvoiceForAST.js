		...
		function suiteletInvoiceLayout(request, response)
		{
			...
			strName += "<table width=\"100\%\" font-family=\"Helvetica\">";
			strName += "<tr>";
			strName += "<td border-top=\"0.5\" width = \"30\%\"  align=\"left\" font-size=\"10\"><b>Invoice&nbsp;</b>#&nbsp;"+Invoice_no+"<br/><b>Time Period:&nbsp;</b>"+Time_period+"<br/><b>Terms:&nbsp;</b>"+terms+"<br/><b>Due:&nbsp;</b>"+due+"<br/><b>Project: </b>"+proj1+"<br/><b>Customer PO#:&nbsp;</b>"+po_no+"<br/></td>";
			...
			*/
			...
			columns[0] = new nlobjSearchColumn("formuladate",null,"GROUP");
			...
			//columns[12] = new nlobjSearchColumn("custcol_cust_date",null,"GROUP");
			...
			strName += "<td table-layout = \"fixed\" border-top=\"0.5\" border-bottom=\"0.5\" width = \"30\%\" font-size=\"10\" align=\"left\"><b>Time Period</b></td>";
			strName += "<td table-layout = \"fixed\" border-top=\"0.5\" border-bottom=\"0.5\" width = \"35\%\" font-size=\"10\"><b>Task</b></td>";
...
/*					
					date = searchResults[i].getValue('custcol_oa_date_description');
					dateArr.push(date);
					//nlapiLogExecution('DEBUG','Search Result','date is :='+date); 
					
			
						
					hours = searchResults[i].getValue('custcol_oa_hours_description');
					hourSum =  parseFloat(hourSum) + parseFloat(hours);
					hoursArr.push(hours);
					//nlapiLogExecution('DEBUG','Search Result','hourSum is :='+hourSum);
					
					rate = searchResults[i].getValue('custcol_oa_rate_description');
					var myTrunc = Math.round(rate);
					myTruncArr.push(myTrunc)
					//nlapiLogExecution('DEBUG','Search Result','myTrunc is :='+myTruncArr);
					...
					var totalAmount = parseInt(hours) * parseFloat(rate);
...
*/			
			...
			var subresourceTotal1=0;
				...
				for (var m = 0;  m < counsaltantUniq1.length; m++) 
				{
					...
					strName += "<td table-layout = \"fixed\" border-bottom=\"0.5\" width = \"30\%\" font-size=\"10\"></td>";
					strName += "<td table-layout = \"fixed\" border-bottom=\"0.5\" width = \"35\%\" font-size=\"10\"></td>";
					...
					nlapiLogExecution('DEBUG','Search Result','searchResults.lengthis :='+searchResults.length);
					...
					//	nlapiLogExecution('DEBUG','Search Result','date2 is :='+date2);
						...
						var invoiceSearch = nlapiSearchRecord("invoice",null,
								[
								   ...
								   "AND", 
								   ["custcol_cust_date","isnotempty",""]
								], 
								[
								   new nlobjSearchColumn("custcol_cust_date"),
								   new nlobjSearchColumn("custcol_oa_user_description")
								]
								);
					
						 nlapiLogExecution('DEBUG','Search Result','invoiceSearch.length is :='+invoiceSearch.length);
						for (var zx = 0;  zx < invoiceSearch.length;zx++) 
						{
							var newDate = invoiceSearch[zx].getValue("custcol_cust_date");
							
							var User = invoiceSearch[zx].getValue("custcol_oa_user_description");
							...
							//    nlapiLogExecution('DEBUG','Search Result','sunday.length is :='+sunday.toDateString());
							//    nlapiLogExecution('DEBUG','Search Result','date2.length is :='+date2.toDateString());
						
						 if(sunday.toDateString() == date2.toDateString() && User == counsaltant1 )  
                       {
											    ...
											    var year4 = firstDay.getFullYear();
										    	 ...
										    	 var month3 = lastDay.getMonth() + 1;
												    ...
												    var year3 = lastDay.getFullYear();
											    	 ...
											    	 nlapiLogExecution('DEBUG','Search value for startNend','CurrentDate is :='+now);
											    	 nlapiLogExecution('DEBUG','Search value for startNend','Monday is :='+d2); 
											    	 nlapiLogExecution('DEBUG','Search value for startNend','SUnday is :='+d1); 
											    	 nlapiLogExecution('DEBUG','Search value for startNend','FirstDay is :='+d4); 
											    	 nlapiLogExecution('DEBUG','Search value for startNend','LastDay is :='+d3); 
											    	 nlapiLogExecution('DEBUG','Search value for startNend','now.getMonth() is :='+now.getMonth());
											    	 nlapiLogExecution('DEBUG','Search value for startNend','firstDay.getMonth() is :='+firstDay.getMonth());
											    	 nlapiLogExecution('DEBUG','Search value for startNend','lastDay.getMonth() is :='+lastDay.getMonth());
											    	 nlapiLogExecution('DEBUG','Search value for startNend','monday.getMonth() is :='+monday.getMonth());
											    	 nlapiLogExecution('DEBUG','Search value for startNend','sunday.getMonth() is :='+sunday.getMonth());
											    	 
											    if(monday.getMonth() == sunday.getMonth())
											    {
											    	// return d +' - '+ d1;
											    		var value1= d2+'-'+d1;
											    		 nlapiLogExecution('DEBUG','Search value for startNend','Inside condition 1 is :='+sunday.getMonth());
											    		// nlapiLogExecution('DEBUG','Search value for startNend','sunday.getMonth() is :='+sunday.getMonth());
											    }
											   
											    if( monday.getMonth() != sunday.getMonth() &&  now.getMonth() ==  sunday.getMonth())
											    {
											    	 nlapiLogExecution('DEBUG','Search value for startNend','Inside condition2  is :='+sunday.getMonth());
											    	 
											    	 var value1= d4+'-'+d1 ;
											    }
											    else  
											    {
											    	nlapiLogExecution('DEBUG','Search value for startNend','Inside condition 3 is :='+sunday.getMonth());
					...
					//	nlapiLogExecution('DEBUG','Search value for startNend','value for startEnd is :='+value1); 
						...
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.5\" width = \"30\%\" font-size=\"10\" align=\"left\">"+value1+"</td>";
						strName += "<td table-layout = \"fixed\" border-bottom=\"0.5\" width = \"35\%\" font-size=\"10\">"+task1+"</td>";
					...
					subresourceTotal1 = parseFloat(subresourceTotal1) +parseFloat(resourceTotal1);
					 ...
					 strName += "<td border-bottom=\"0.5\" width = \"30\%\" font-size=\"10\"></td>";
					 strName += "<td border-bottom=\"0.5\" width = \"35\%\" font-size=\"10\"><b>Resource Time Sub-total</b></td>";
				...
				strName += "<td border-bottom=\"0.5\" width = \"25\%\" font-size=\"10\"></td>";
				strName += "<td border-bottom=\"0.5\" width = \"30\%\" font-size=\"10\"></td>";
				strName += "<td border-bottom=\"0.5\" width = \"35\%\" font-size=\"10\"><b>Time Total</b></td>";
	...
	//---------------------------------Expense Time Entry-------------------------------    
				...
				column[5] = new nlobjSearchColumn("formuladate",null,"GROUP");
				columns[6] = new nlobjSearchColumn("currency","applyingTransaction","GROUP");
				columns[7] = new nlobjSearchColumn("grossamount","applyingTransaction","SUM");
				columns[8] = new nlobjSearchColumn("amount","applyingTransaction","SUM");
				columns[9] = new nlobjSearchColumn("amount",null,"SUM");
				columns[8] = new nlobjSearchColumn("fxamount",null,"SUM");
				columns[9] = new nlobjSearchColumn("fxamount","applyingTransaction","SUM");
				...
				strName += "<td border-top=\"0.5\" border-bottom=\"0.5\" width = \"13\%\" font-size=\"10\" align=\"right\"><b>"+subhourSum1+"</b></td>";
				strName += "<td border-top=\"0.5\" border-bottom=\"0.5\" width = \"20\%\" font-size=\"10\"></td>";
				strName += "<td border-top=\"0.5\" border-bottom=\"0.5\" width = \"19\%\" font-size=\"10\" align=\"right\"><b>"+currency+"$&nbsp;"+subresourceTotal1+"</b></td>";
				strName += "</tr>";
			...
			*/
			...
			strName += "<td border-top=\"0.5\" table-layout = \"fixed\" width = \"13\%\" font-size=\"10\" align=\"left\"><b>Time Period</b></td>";
			strName += "<td border-top=\"0.5\" table-layout = \"fixed\" width = \"25\%\" font-size=\"10\"><b>Expense Type</b></td>";
			...
			if (expSearchResults != null && expSearchResults != '')
			{
				...
				for (var p = 0;  p < expSearchResults.length; p++) 
				{
					...
					ExpDate = expSearchResults[p].getText("formuladate",null,"GROUP");
					ExpDateArray.push(ExpDate);
					//nlapiLogExecution('DEBUG','Search Result','Expence Date is :='+ExpDateArray);	
					
					amount = expSearchResults[p].getValue("amount","applyingTransaction","SUM");
					amountArray.push(amount);
					//nlapiLogExecution('DEBUG','Search Result','Expence Date is :='+amountArray);	
				
					ExpCurrency = expSearchResults[p].getValue("currency","applyingTransaction","GROUP");
					ExpCurrencyArray.push(currency);
					//nlapiLogExecution('DEBUG','Search Result','Expence currency is :='+ExpCurrencyArray);
				}//End of for
			...
			for (var x = 0;  x < expCounsaltantUniq.length; x++) 
			{
				...
				strName += "<td border-top=\"0.5\" table-layout = \"fixed\" width = \"15\%\" font-size=\"10\"></td>";
				strName += "<td border-top=\"0.5\" table-layout = \"fixed\" width = \"25\%\" font-size=\"10\"></td>";
				...
				//	ExpDateArray.push(ExpDate);
				//	nlapiLogExecution('DEBUG','Search Result','Expence Date2 is :='+date2);	
					
					var date1 = new Date(expSearchResults[q].getValue("formuladate",null,"GROUP"));
					 date1.setDate( date1.getDate() - 6 );
					// nlapiLogExecution('DEBUG','Search Result','Expence Date1 is :='+date1);	
							    	   ...
							    	   var month1 = date2.getMonth() + 1;
									    ...
									    var year1 = date2.getFullYear();
								    	 ...
								    	 var month4 = firstDay.getMonth() + 1;
										    ...
										    else if(date1.getMonth() != date2.getMonth() && date1.getMonth() == lastDay.getMonth())
										    {
										    	// return [d +' - '+ d3];
										    		var value1= d2+'-'+d3;
										    }
				...
				//	nlapiLogExecution('DEBUG','Search value for startNend','value for startEnd is :='+value1); 
					...
					strName += "<td table-layout = \"fixed\" border-top=\"0.5\" width = \"15\%\" font-size=\"10\" align=\"left\">"+value1+"</td>";
					strName += "<td table-layout = \"fixed\" border-top=\"0.5\" width = \"25\%\" font-size=\"10\">"+ExpenseType+"</td>";
			    ...
			    strName += "<td border-top=\"0.5\" width = \"15\%\" font-size=\"10\"></td>";
				strName += "<td border-top=\"0.5\" width = \"25\%\" font-size=\"10\"><b>Resource Expense Sub-total</b></td>";
				...
				strName += "<td border-top=\"0.5\" border-bottom=\"0.5\" width = \"15\%\" font-size=\"10\"></td>";
				strName += "<td border-top=\"0.5\" border-bottom=\"0.5\" width = \"25\%\" font-size=\"10\"><b>Expense Total</b></td>";
			...
			strName += "<td border-top=\"0.5\" border-bottom=\"0.5\" width = \"17\%\" font-size=\"10\"></td>";
			strName += "<td border-top=\"0.5\" border-bottom=\"0.5\" width = \"15\%\" font-size=\"10\"></td>";
			strName += "<td border-top=\"0.5\" border-bottom=\"0.5\" width = \"25\%\" font-size=\"10\" align=\"center\"><b>Total</b></td>";
			strName += "<td border-top=\"0.5\" border-bottom=\"0.5\" width = \"10\%\" font-size=\"10\" align=\"right\"></td>";
			strName += "<td border-top=\"0.5\" border-bottom=\"0.5\" width = \"10\%\" font-size=\"10\"></td>";
			strName += "<td border-top=\"0.5\" border-bottom=\"0.5\" width = \"10\%\" font-size=\"10\" align=\"right\"><b>"+ExpCurrency+"$&nbsp;"+tot.toFixed(2)+"</b></td>";
			strName += "</tr>";
			}
			strName += "</table>";

	function suiteletStatement(request,response)
	{
		...
		//-----------------------------Fetch Values-------------------------------------------
		 for(var l=0;l<jsonArray3.length;l++)
		 {
			...
			strName += "<td  background-color = \"#DEDBDB\" align = \"center\" font-size=\"9\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"20\%\"><b>1-30 Days</b></td>";
			...
			strName += "<td  background-color = \"#DEDBDB\" align = \"center\" font-size=\"9\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"47\%\"><b>61-90 Days</b></td>";
			...
			strName += "<td  background-color = \"#DEDBDB\" align = \"center\" font-size=\"9\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"15\%\"><b></b></td>";
			strName += "<td  background-color = \"#DEDBDB\" align = \"center\" font-size=\"9\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" border-right=\"solid 1px black\" width=\"15\%\"><b>Amount Due</b></td>";
			strName += "</tr>";
			...
			var totaldue = 0;
			   ...
			   for(var p=0;p<jsonArray1.length;p++)
				{
				   var date2 =  new Date(jsonArray1[p].date); 
					
					diffDays = (date2.getTime() - date1.getTime()); 
					diffDays = Math.round(diffDays/(3600*1000*24));
					
					nlapiLogExecution('DEBUG', 'aftr submit', "  jsonArray1[p].date ==" +jsonArray1[p].date);
					nlapiLogExecution('DEBUG', 'aftr submit', "  jsonArray1[p].entity  ==" + jsonArray1[p].entity);
					nlapiLogExecution('DEBUG', 'aftr submit', "  jsonArray1[p].tranid  ==" + jsonArray1[p].tranid);
					nlapiLogExecution('DEBUG', 'aftr submit', "  jsonArray1[p].recType  ==" +jsonArray1[p].type);
					nlapiLogExecution('DEBUG', 'aftr submit', "  jsonArray1[p].formulacurrency  ==" +jsonArray1[p].formulacurrency);
	
					
						if((jsonArray1[p].type == 'Invoice') ) //&& jsonArray2[p].status == 'open'
					 {
						if(diffDays <= 0)
						{	
					...
					if((jsonArray1[p].type == 'Credit Memo') ) //&& jsonArray2[p].status == 'open'
					{
						if(diffDays <= 0)
						{	
							current = parseFloat(current)+ parseFloat(jsonArray1[p].formulacurrency);
				...
				strName += "<tr>";
				strName += "<td  align = \"center\" font-size=\"9\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"15\%\"><b>"+formatNumber(parseFloat(current).toFixed(2))+"</b></td>";
				strName += "<td  align = \"center\" font-size=\"9\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"20\%\"><b>"+formatNumber(parseFloat(over0).toFixed(2))+"</b></td>";
				strName += "<td  align = \"center\" font-size=\"9\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"30\%\"><b>"+formatNumber(parseFloat(over30).toFixed(2))+"</b></td>";
				strName += "<td   align = \"center\" font-size=\"9\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"47\%\"><b>"+formatNumber(parseFloat(over60).toFixed(2))+"</b></td>";
		     	strName += "<td   align = \"center\" font-size=\"9\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"30\%\"><b>"+formatNumber(parseFloat(over90).toFixed(2))+"</b></td>";
				strName += "<td   align = \"center\" font-size=\"9\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"15\%\"><b></b></td>";
				strName += "<td   align = \"center\" font-size=\"9\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" border-right=\"solid 1px black\" width=\"15\%\"><b>"+formatNumber(parseFloat(totaldue).toFixed(2))+"</b></td>";
				strName += "</tr>";

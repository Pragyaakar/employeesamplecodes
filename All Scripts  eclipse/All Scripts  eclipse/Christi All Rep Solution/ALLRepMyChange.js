		    				    ...
		    				    var FinIncometotal =0.00;
		    				    	...
		    				    	// for (var j2=0;j2<AllRep.length;j2++)
		    				    	{
		    				    		...
		    				    		filters1[0] = new nlobjSearchFilter ('trandate', null, 'within', startDate,endDate);
		    				 			filters1[1] = new nlobjSearchFilter ("custcol_cust_line_rep",null,'is','David Neal');//AllRep[j2]
		    				    		...
		    				    		if (searchResultItem1 != null)
				    					{
					    				    ...
					    				    var amt8=0.00;
				    				    		...
				    				    		nlapiLogExecution('DEBUG','AllREP Report','[Income ->'+income +'][Inv and CM ->'+amt+']'+'][ShipCostTotal ->'+ShipCostTotal+']');
				    				    		nlapiLogExecution('DEBUG','AllREP Report','[Income ->'+income +'][Income JV ->'+amt8+']'+'][Expense JV ->'+amt7+']');
							    			   nlapiLogExecution('DEBUG','AllREP Report','[expense ->'+expense+'][IR ->'+amt6+']'+'][IF n InvAdj ->'+amt5+']'+'][VenBill n VenCredit ->'+amt1+']');
							    				   
				    				    		 nlapiLogExecution('DEBUG','AllREP Report','->AllRep=DavidNeal income='+parseFloat(income).toFixed(2)+' expense'+parseFloat(expense).toFixed(2));
		    		...
		    		html +=  '<table width="100%"><tbody><tr><th class="tableheader">Sales Rep</th><th class="tableheader">Customer</th><th class="tableheader">Order</th><th class="tableheader">Date</th><th class="tableheader">Trans.</th><th class="tableheader">Description</th><th class="tableheader" align="right">Vendor</th><th class="tableheader" align="right">Income</th><th class="tableheader" align="right">Expense</th><th class="tableheader" align="right">GP$</th><th class="tableheader" align="right">GP%</th></tr>'
    				    ...
    				    var FinIncometotal =0.00;
    				    	...
    				    	// for (var j2=0;j2<AllRep.length;j2++)
    				    	{
    				    		var filters1 = [];
    				    		filters1[0] = new nlobjSearchFilter ('trandate', null, 'within', startDate,endDate);
    				 			filters1[1] = new nlobjSearchFilter ("custcol_cust_line_rep",null,'contains','Alfred');//AllRep[j2]

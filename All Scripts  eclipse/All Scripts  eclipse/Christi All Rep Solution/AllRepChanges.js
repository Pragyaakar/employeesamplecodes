		    				    		...
		    				    		if (searchResultItem1 != null)
				    					{
					    				    ...
					    				    var amt8=0.00;
							    			  ...
							    			  */
				    				    		...
				    				    		nlapiLogExecution('DEBUG','AllREP Report','[Expense ->'+expense +'][VenBillnCredit ->'+amt1+']'+'][IF n Adjust ->'+amt5+']'+'][IR ->'+amt6+']'+'][JV expnse ->'+amt7+']');

	...
	if(!isEmpty(searchResult)){
		...
		for (var searchResultIndex = 0; searchResultIndex < searchResult.length; searchResultIndex++) {
			...
			else 
			{
			 ...
			 if(transactionType !='Journal' && searchResult2Map[customer+'_'+orderNumber+'_'+documentNumber])
			 {
			...
			var tempAmount =0.00;
			  ...
			  if(tranType ==='Journal')
			  {
				 ...
				 // nlapiLogExecution('DEBUG', 'searchResult2Map','Account;='+ noOfacc);
				  ...
				  searchResult2Map[customer+'_'+orderNumber+'_'+documentNumber] =searchResult2Map[customer+'_'+orderNumber+'_'+documentNumber+'_'+newJv];

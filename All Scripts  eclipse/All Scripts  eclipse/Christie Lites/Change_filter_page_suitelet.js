	...
	function showForm(request,response){
	 ...
	 else 
	  {
		...
		form.addButton('custpage_email_excel_report', 'E-mail', 'email_excel_report()');
	 ...
	 // var yesterday = new Date(year1, 0, 1);
	  ...
	  //==============
		...
		//================ Email Fields ==========================
		var subject = form.addField('custpage_subject','text', 'Email-Subject');
	    subject.setBreakType('startrow');
	   
	    var message = form.addField('custpage_message','textarea', 'Email-Message');
	    message.setBreakType('startcol');
	   // message.setDisplaySize( 30, 10 );
		...
		form.addField('custpage_customer', 'select', 'SELECT CUSTOMER', 'customer').setBreakType('startcol');
		 var recipient = form.addField('custpage_recipient','email', 'Recipient Email');
		    recipient.setBreakType('startrow');

function INvoiceLoadToCreateTransAction(request,response)
{
  ...
  var  recObj = nlapiLoadRecord('invoice',recId);
	...
	var amount =recObj.getFieldValue('amountremainingtotalbox');// amountremainingtotalbox
  nlapiLogExecution('DEBUG', 'aftr submit', "  amount  ==" + amount);
	 ...
	 var customerBody = recObj.getFieldValue('entity');
	  ...
	  nlapiLogExecution('DEBUG', 'aftr submit', "  PRlinecount  ==" + PRlinecount);
        	...
        	nlapiLogExecution('DEBUG', 'aftr submit', "  quantity  ==" + quantity);
            	...
            	nlapiLogExecution('DEBUG', 'aftr submit', "  vendorname  ==" + vendorname);
         		...
         		if(location !=null && location !='' && location != undefined)
         		{
         		 ...
         		 var Class = recObj.getLineItemValue('item','class',i);
            	...
            	//var amount =recObj.getLineItemValue('item','grossamt',i);    
            	//amtArr.push(amount);
		...
		createInvAdjustViaPR(PRlinecount,recId,customerBody,date,location,vendArr,amtArr,line_chkArr,Class,Department,location,rateArray,recId,itemArray,qtyArray,units,descriptionArray,subsidiary,typeItemArr,amount);
		
}	
	

function createInvAdjustViaPR(PRlinecount,recId,customerBody,date,location,vendArr,amtArr,line_chkArr,Class,Department,location,rateArray,recId,itemArray,qtyArray,units,descriptionArray,subsidiary,typeItemArr,amount)
{	
	...
	record.setCurrentLineItemValue('line', 'location', location);
	record.setCurrentLineItemValue('line', 'department', Department);
	record.setCurrentLineItemValue('line', 'class', Class);

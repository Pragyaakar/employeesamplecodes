...
{
	if(parseInt(day) === parseInt(Day))  //TIMEZONE
	{
	
	 var amtInlitr;
	
	var searchId='customsearch_total_litres_sold';
	var searchId1='customsearch_total_litres_sold';
	
	resultSet = findTransaction(searchId);
	resultSet = findTransaction1(searchId);
...
function findTransaction1(searchId1)
{

					...
					if (previousInternalID != internalID)
					{
				     ...
				     else
				     {
				       ...
				       if (parseFloat(value9) != null && parseFloat(value9) != '' && parseFloat(value9) != undefined ) 
						{
				    		//nlapiLogExecution('DEBUG', 'ScheduleTest', 'value9 = ' + value9);
						...
						{
							value11 =' ';
							strName += "<td  width = \"20\%\" padding-left=\"2em\" padding-right=\"2em\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\"  align=\"center\" style=\" white-space: nowrap;\">"+value11+"</td>";
				        }
						else 
						{
						...
						if (Status == 'open') 
						{
							...
							{
								var GainOrLoss = parseFloat(value9) -(parseFloat(value11) * value12);
	                        //  nlapiLogExecution('DEBUG', 'same currency Unreal Gain/loss', 'value9 = ' + value9);
	                        //  nlapiLogExecution('DEBUG', 'same currency Unreal Gain/loss', 'value11 = ' + value11);
	                        //  nlapiLogExecution('DEBUG', 'same currency Unreal Gain/loss', 'Search ExRate = ' + value12);
							}
							else
							{
							//	nlapiLogExecution('DEBUG', 'ScheduleTest', 'currency = ' + currency);
							//	nlapiLogExecution('DEBUG', 'ScheduleTest open', 'Effective Date = ' + today1);
								...
								var rate = nlapiExchangeRate(value10,1,today1); 
							//	 nlapiLogExecution('DEBUG', 'Diff currency Unreal Gain/loss', 'value9 = ' + value9);
	                         // nlapiLogExecution('DEBUG', 'diff currency Unreal Gain/loss', 'value11 = ' + value11);
	                         // nlapiLogExecution('DEBUG', 'diff currency Unreal Gain/loss', 'Nlapi ExRate = ' + rate);

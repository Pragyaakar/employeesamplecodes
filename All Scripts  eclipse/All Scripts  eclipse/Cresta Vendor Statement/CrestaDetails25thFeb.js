 ...
 //=========================================Vendor Address=====================================
  //  var vendor_deatil = nlapiLookupField('vendor',vendor_a,'entityid');
   ...
   // for (var z = 0; z < vendor_a.length; z++) 
	        ...
	        var url = 'https://5250587.app.netsuite.com/core/media/media.nl?id=1523&c=5250587&h=17ae16c781b9b3859c5d&fcts=20190928031152&whence=';
                
                //'https://5250587-sb1.app.netsuite.com/core/media/media.nl?id=11&c=5250587_SB1&h=26ed5665b8c23cd266f5'; 
	        
                              //https://5250587.app.netsuite.com/core/media/media.nl?id=1523&c=5250587&h=17ae16c781b9b3859c5d&fcts=20190928031152&whence=
	    /*    strName += "<table  width=\"100\%\">";
	        strName += "<tr>";
	        strName += "<td>";
			...
			*/
			...
			strName += "<td width = \"20\%\"  align=\"left\" font-size=\"10\"><br/></td>";
			strName += "<td width = \"34\%\"  align=\"left\" font-size=\"17.5\"><br/><b>Vendor Statement</b></td>";
			strName += "</tr>";	
			strName += "</table>";
			...
			strName += "<table style=\"table-layout: fixed;\" align=\"left\" width=\"100\%\">";
			strName += "<tr>";
			...
			strName += "<td width = \"45\%\"  align=\"left\" font-size=\"10\"><b>"+venText+"</b></td>";//
			strName += "</tr>";
	...
	strName += "<td border-top=\"solid 1px black\" border-bottom=\"solid 1px black\" width = \"20\%\" border-left=\"solid 1px black\"  align=\"center\" border-collapse=\"collapse\" padding-left=\"2em\" padding-right=\"2em\" style=\" white-space: nowrap;\"><b>Primary Currency</b></td>";//LCY(USD)
...
function XMLConversion(strName,recepient,display_date)
{
    ...
    xml += "  <\/macrolist>";
    xml += "<\/head>";
	xml += "<body margin-top=\"0pt\" footer=\"myfooter\" footer-height=\"2em\" size=\"A3-landscape\">";
   	xml += strName;
	xml += "</body>\n</pdf>";
	var file = nlapiXMLToPDF(xml);

 ...
 //=========================================Vendor Address=====================================
  //  var vendor_deatil = nlapiLookupField('vendor',vendor_a,'entityid');
   ...
   // for (var z = 0; z < vendor_a.length; z++) 
    ...
    strName += "<tr>";
	strName += "<td  width = \"20\%\" padding-left=\"1em\" style=\" white-space: nowrap;\"  align=\"center\"><b>On:"+convertDate1(start,dateformat)+"</b></td>";	
	strName += "<td  width = \"20\%\" padding-left=\"1em\"  align=\"right\"><b></b></td>";
	strName += "<td  width = \"20\%\" padding-left=\"1em\" style=\" white-space: nowrap;\"  align=\"center\"><b>Open Balance:</b></td>";	
	strName += "<td  width = \"20\%\" padding-left=\"1em\" style=\" white-space: nowrap;\"  align=\"center\"><b>"+parseFloat(openingBalance).toFixed(2)+"</b></td>";
	strName += "<td  width = \"20\%\" padding-left=\"1em\"  align=\"center\"><b></b></td>";	
	strName += "<td  width = \"20\%\" padding-left=\"1em\" style=\" white-space: nowrap;\"  align=\"center\"><b>"+parseFloat(openingBalanceFx).toFixed(2)+"</b></td>";
	strName += "<td  width = \"20\%\" padding-left=\"1em\"  align=\"center\"><b></b></td>";	

		 ...
		 */
			function suiteletStatement(request,response)
			{
					...
					if(transItemSearch4)
					{
						...
						for(var i=0;i<transItemSearch4.length;i++)
						{
							var jsonObj = {
													...
													'tranid':transItemSearch4[i].getValue("tranid",null,"GROUP"),
				...
				//	nlapiLogExecution('DEBUG', 'aftr submit', "  jsonArray1[l].formulacurrency  ==" +DocNumArr);
					...
					var DueDayArr = new Array();
						...
						for(var i=0;i<transItemSearch3.length;i++)
						{
							var jsonObj = {
								    ...
								    'against_inv_pay' :transItemSearch3[i].getValue("applyingforeignamount",null,"SUM"), 
								    ...
								    'apply_date':transItemSearch3[i].getValue("trandate","applyingTransaction","GROUP"),
						   ...
						   for(var l5=0;l5<jsonArray3.length;l5++)
							{
						 
							   TypeArr.push(jsonArray3[l5].tranid);
							   EntityArr.push(jsonArray3[l5].tranid_apply);
							   tranIdArr.push(jsonArray3[l5].apply_date);
							}
					    ...
					    var newArray = findDuplicates(TypeArr);
					    var newArray1 =findDuplicates(EntityArr);
					    var newArray2 =findDuplicates(tranIdArr);
					  
					  
					    
					  //   var newArray = removeDuplicate(jsonArray3, 'tranid');
					 //   valNew = removeDuplicates(jsonArray3);
					   nlapiLogExecution('DEBUG', 'aftr submit', "  newArray ==" + newArray);
					   nlapiLogExecution('DEBUG', 'aftr submit', "  newArray1 ==" + newArray1);
					   nlapiLogExecution('DEBUG', 'aftr submit', "  newArray2 ==" + newArray2);
		      ...
		      newArrToMerge=mergeArrays(jsonArray4,jsonArray3); 
		      
		      jsonArray5=mergeArrays(newArrToMerge,newPayArr);
		    ...
		    var columnPay =0;
		      ...
		      var BalTotal2 = parseFloat(BalTotal1) + parseFloat( openBalanceWithPayMent );
				...
				//-----------------------------Fetch Values-------------------------------------------
				 for(var l=0;l<jsonArray5.length;l++)
				 {
				    	 var doc = jsonArray5[l].tranid;
					     var doc1 = jsonArray5[l].tranid_apply;
					     var InvAmt =jsonArray5[l].inv_amount;
					      var InvPayAmt = jsonArray5[l].against_inv_pay;
					      var aplyDate = jsonArray5[l].apply_date;
					      var invDate = jsonArray5[l].date;//apply_date   
				
					          //  nlapiLogExecution('DEBUG', 'aftr submit', "  newArray.indexOf(jsonArray5[l].tranid) > -1 ==" +newArray.indexOf(jsonArray5[l].tranid) > -1);
					            
					          //  nlapiLogExecution('DEBUG', 'aftr submit', "  jsonArray5[l].status=='CustInvc:B' ==" +jsonArray5[l].status=='CustInvc:B');
					            
					                 if( newArray.indexOf(jsonArray5[l].tranid) > -1  && jsonArray5[l].type == 'CustInvc' && jsonArray5[l].status=='CustInvc:B')
					                 {
					                	  zero1++;
					                	  
					                	     if(zero1 == 2)
						                	 {
					                	    	 nlapiLogExecution('DEBUG', 'aftr submit', "zero1 == 2  && InvAmt == InvPayAmt "+InvAmt +"=="+ InvPayAmt);
					                	    	// jsonArray5[l].invpay_amount =InvPayAmt;
						                		 continue; 
					                 ...
					                 if( newArray.indexOf(jsonArray5[l].tranid) > -1  && jsonArray5[l].type == 'CustInvc' && jsonArray5[l].status=='CustInvc:A'  )
					                 {
					                	  zero++;
					                	  
					                	     if(zero == 2 )
						                	 {
					                	    	 nlapiLogExecution('DEBUG', 'aftr submit', "zero == 2   ");
						                		 continue; 
						         ...
						         if(jsonArray5[l].inv_amount != null && jsonArray5[l].inv_amount != undefined && jsonArray5[l].inv_amount != ' ' && jsonArray5[l].inv_amount > 0 && jsonArray5[l].type !='Credit Memo')
									{
						         ...
						         else if(jsonArray5[l].inv_amount != null && jsonArray5[l].inv_amount != undefined && jsonArray5[l].inv_amount != ' ' && jsonArray5[l].inv_amount > 0 && jsonArray5[l].type =='Credit Memo')
						         {
						      ...
						      //   nlapiLogExecution('DEBUG', 'aftr submit', " DocNumArr.indexOf(jsonArray5[l].tranid_apply)  ==" +DocNumArr.indexOf(jsonArray5[l].tranid_apply));
										...
										{
						                	// nlapiLogExecution('DEBUG', 'aftr submit', "else if   .pay_amount 1 ");
						                ...
						                else if(jsonArray5[l].pay_amount == null && jsonArray5[l].pay_amount == undefined && jsonArray5[l].pay_amount == '')
						                {
						                	 ...
						                	 jsonArray5[l].pay_amount =0;
						                //	 nlapiLogExecution('DEBUG', 'aftr submit', "else if   .pay_amount 2");
							            	 strName += "<td align = \"center\" font-size=\"9\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"30\%\">"+formatNumber(jsonArray5[l].pay_amount)+"</td>"; 
						                }
							             else
							             {
							            	 ...
							            	 else if(InvAmt != InvPayAmt && (InvPayAmt!=null && InvPayAmt!='' && InvPayAmt!=undefined))
							            		 {
							            		   jsonArray5[l].invpay_amount =parseFloat(jsonArray5[l].invpay_amount)- parseFloat(InvPayAmt); 
							            		 }
							            	 else
							            	 {
							            		 jsonArray5[l].invpay_amount =0; 
							            	 }
							            	 nlapiLogExecution('DEBUG', 'aftr submit', "else if   .invpay_amount 1");
							            	 strName += "<td align = \"center\" font-size=\"9\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"30\%\">"+formatNumber(jsonArray5[l].invpay_amount)+"</td>"; 
							             }

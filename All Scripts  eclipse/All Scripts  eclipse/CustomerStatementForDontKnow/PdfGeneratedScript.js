		      ...
		      var BalTotal2 = parseFloat(BalTotal1) + parseFloat( openBalanceWithPayMent );
				...
				//-----------------------------Fetch Values-------------------------------------------
			     ...
			     var FinTotal = parseFloat(BalTotal) + parseFloat(openBalanceWithPayMent);
					...
					strName += "<td  background-color = \"#DEDBDB\" align = \"center\" font-size=\"9\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"10\%\"><b>"+formatNumber(PayTotal.toFixed(2))+"</b></td>";

		...
		function suiteletVendorBillLayout(request, response)
		{
			...
			strName += "</td>";
			strName += "<td colspan =\"6\" width = \"100\%\"  align=\"right\"><b>ORIGINAL FOR RECIPIENT/BUYER</b></td>";	
			strName += "</tr>";
			strName += "</table>";
			
			strName += "<table width=\"100\%\" table-layout = \"fixed\">";
			strName += "<tr>";
			strName += "<td table-layout = \"fixed\" width=\"35\%\" font-size=\"12\" align=\"center\"><b>TAX INVOICE</b></td>";
			strName += "</tr>";
			strName += "<tr>";
			strName += "<td table-layout = \"fixed\" width=\"35\%\" font-size=\"9\" align=\"center\">(Under Section 31 of CGST/SGST Act 2017 read with Rule 46 of CGST Rules,2017)<br/><br/></td>";
			strName += "</tr>";
			strName += "</table>";
			
			strName += "<table width=\"100\%\" table-layout = \"fixed\">";
			strName += "<tr>";
			strName += "<td table-layout = \"fixed\" width=\"35\%\" font-size=\"12\" align=\"center\"><b>"+nlapiEscapeXML(vendName)+"</b></td>";
			strName += "</tr>";
			strName += "<tr>";
			strName += "<td table-layout = \"fixed\" width=\"35\%\" font-size=\"9\" align=\"center\">"+nlapiEscapeXML(venAddress)+"</td>";
			strName += "</tr>";
			strName += "<tr>";
			strName += "<td table-layout = \"fixed\" width=\"35\%\" font-size=\"9\" align=\"center\">GSTIN :&nbsp;"+gstinNo+", PAN :&nbsp;"+panNo+"<br/></td>";
			strName += "</tr>";
			strName += "</table>";
			...
			strName += "<td table-layout = \"fixed\" width=\"30\%\" font-size=\"11\" align=\"right\"><b>Transaction Number.:</b>&nbsp;"+tran_number+"</td>";
			//strName += "<td table-layout = \"fixed\" width=\"5\%\" font-size=\"11\" align=\"right\"></td>";
			strName += "</tr>";
			strName += "<tr>";
			//strName += "<td table-layout = \"fixed\" width=\"35\%\" font-size=\"11\" align=\"right\"></td>";
			strName += "<td table-layout = \"fixed\" width=\"30\%\" font-size=\"11\" align=\"right\"><b>Invoice No.:</b>&nbsp;"+invoice_num+"</td>";
			//strName += "<td table-layout = \"fixed\" width=\"5\%\" font-size=\"11\" align=\"right\"></td>";
			strName += "</tr>";
			strName += "<tr>";
			//strName += "<td table-layout = \"fixed\" width=\"5\%\" font-size=\"11\" align=\"right\"></td>";
			strName += "<td table-layout = \"fixed\" width=\"15\%\" font-size=\"11\" align=\"right\"><b>Invoice Date:</b>&nbsp;"+invoice_date+"</td>";
			//strName += "<td table-layout = \"fixed\" width=\"5\%\" font-size=\"11\" align=\"right\"></td>";
			strName += "</tr>";
			strName += "</table>";
			...
			strName += "<table width=\"100\%\">";
			strName += "<tr>";
			strName += "<td width=\"49\%\" font-size=\"11\" align=\"left\" border-top = \"solid 1px black\" border-bottom = \"solid 1px black\" border-left = \"solid 1px black\"><b>Items/Services</b></td>";
			strName += "<td width=\"67\%\" font-size=\"11\" align=\"center\" border-top = \"solid 1px black\" border-bottom = \"solid 1px black\"><b>Description</b></td>";
			strName += "<td width=\"40\%\" font-size=\"11\" align=\"center\" border-top = \"solid 1px black\" border-bottom = \"solid 1px black\"><b>HSN<br/>Code</b></td>";
			strName += "<td width=\"45\%\" font-size=\"11\" align=\"center\" border-top = \"solid 1px black\" border-bottom = \"solid 1px black\"><b>Quantity</b></td>";
			strName += "<td width=\"53\%\" font-size=\"11\" align=\"center\" border-top = \"solid 1px black\" border-bottom = \"solid 1px black\"><b>Rate</b></td>";
			strName += "<td width=\"43\%\" font-size=\"11\" align=\"center\" border-top = \"solid 1px black\" border-bottom = \"solid 1px black\"><b>Unit</b></td>";
			strName += "<td width=\"45\%\" font-size=\"11\" align=\"center\" border-top = \"solid 1px black\" border-bottom = \"solid 1px black\" border-right = \"solid 1px black\"><b>Amount</b></td>";
			strName += "</tr>";
			...
			for (var i = 1; i <= lineCount; i++)
			{
				...
				var item = ffReqObj.getLineItemValue('item','custcol_itemid_bill',i);
				...
				var itemName = ffReqObj.getLineItemText('item','item',i);
		    	...
		    	var concat = itemName.concat(":").concat(description);//item.concat(description);
		     ...
		     /*   var columns1 = new Array();
				//	 columns[0] = new nlobjSearchColumn('internalid');
					 ...
					 columns1[1] =  new nlobjSearchColumn("displayname");
					 columns1[2] =  new nlobjSearchColumn("itemid");//itemid
			       ...
			       var itemArr =new Array();
					...
					{ 
						var id = results1[j-1].getValue('itemid');
						
						var name = results1[j-1].getValue('displayname');
					
						var cat = id+' '+name;
					   nlapiLogExecution('DEBUG', 'OrderRequisition', 'cat:'+cat);
					   nlapiLogExecution('DEBUG', 'OrderRequisition', 'itemName :'+itemName);
						 if( cat == itemName )
						 {
					 ...
					 nlapiLogExecution('DEBUG', 'OrderRequisition', 'itemArr:'+itemArr);
			    	*/
		    	
		    	strName += "<tr>";
			    strName += "<td width=\"45\%\" font-size=\"10\" align=\"left\" border-left = \"solid 1px black\" >"+nlapiEscapeXML(item)+"</td>";
			    strName += "<td width=\"67\%\" font-size=\"10\" align=\"center\">"+nlapiEscapeXML(concat)+"</td>";
			    strName += "<td width=\"40\%\" font-size=\"10\" align=\"center\">"+ID1+"</td>";
			    strName += "<td width=\"45\%\" font-size=\"10\" align=\"center\">"+qty+"</td>";
			    strName += "<td width=\"53\%\" font-size=\"10\" align=\"center\">"+rate+"</td>";
			    strName += "<td width=\"43\%\" font-size=\"10\" align=\"center\">"+unit+"</td>";
			    strName += "<td width=\"45\%\" font-size=\"10\" align=\"center\" border-right = \"solid 1px black\">"+amount+"</td>";
			    strName += "</tr>";
			...
			for (var x = 1; x <= lineCountexpence; x++)
			{
		    	...
		    	strName += "<tr>";
			    strName += "<td width=\"45\%\" font-size=\"10\" align=\"left\" border-left = \"solid 1px black\" >"+nlapiEscapeXML(item1)+"</td>";
			    strName += "<td width=\"67\%\" font-size=\"10\" align=\"center\">"+nlapiEscapeXML(concat1)+"</td>";
			    strName += "<td width=\"40\%\" font-size=\"10\" align=\"center\">"+ID2+"</td>";
			    strName += "<td width=\"45\%\" font-size=\"10\" align=\"center\"></td>";
			    strName += "<td width=\"53\%\" font-size=\"10\" align=\"center\"></td>";
			    strName += "<td width=\"43\%\" font-size=\"10\" align=\"center\"></td>";
			    strName += "<td width=\"45\%\" font-size=\"10\" align=\"center\" border-right = \"solid 1px black\">"+amount1+"</td>";
			    strName += "</tr>";
			...
			strName += "<td table-layout = \"fixed\" width=\"30\%\" font-size=\"10\" align=\"center\"></td>";
			strName += "<td table-layout = \"fixed\" width=\"25\%\" font-size=\"10\" align=\"center\"></td>";
			strName += "<td table-layout = \"fixed\" width=\"35\%\" font-size=\"10\" align=\"center\"></td>";
			strName += "<td table-layout = \"fixed\" width=\"20\%\" font-size=\"10\" align=\"center\">Taxable Amount</td>";
			strName += "<td table-layout = \"fixed\" width=\"20\%\" font-size=\"10\" align=\"center\"></td>";
			strName += "<td table-layout = \"fixed\" width=\"20\%\" font-size=\"10\" align=\"center\" border-right = \"solid 1px black\">"+tableamount+"</td>";
			strName += "</tr>";
			...
			strName += "<tr>";
			strName += "<td table-layout = \"fixed\" width=\"35\%\" font-size=\"9\" align=\"center\" border-left = \"solid 1px black\"></td>";
			strName += "<td table-layout = \"fixed\" width=\"30\%\" font-size=\"11\" align=\"center\"></td>";
			strName += "<td table-layout = \"fixed\" width=\"25\%\" font-size=\"11\" align=\"center\"></td>";
			strName += "<td table-layout = \"fixed\" width=\"50\%\" font-size=\"11\" align=\"center\"></td>";
			strName += "<td table-layout = \"fixed\" width=\"20\%\" font-size=\"11\" align=\"center\">"+taxcode+"</td>";
			strName += "<td table-layout = \"fixed\" width=\"20\%\" font-size=\"11\" align=\"center\">"+taxrate+"</td>";
			strName += "<td table-layout = \"fixed\" width=\"20\%\" font-size=\"11\" align=\"center\" border-right = \"solid 1px black\">"+taxamount+"</td>";
			strName += "</tr>";
			...
			strName += "<td table-layout = \"fixed\" width=\"30\%\" font-size=\"11\" align=\"center\" border-top = \"solid 1px black\" border-bottom = \"solid 1px black\"></td>";
			strName += "<td table-layout = \"fixed\" width=\"25\%\" font-size=\"11\" align=\"center\" border-top = \"solid 1px black\" border-bottom = \"solid 1px black\"></td>";
			strName += "<td table-layout = \"fixed\" width=\"35\%\" font-size=\"11\" align=\"center\" border-top = \"solid 1px black\" border-bottom = \"solid 1px black\"></td>";
			strName += "<td table-layout = \"fixed\" width=\"20\%\" font-size=\"11\" align=\"center\" border-top = \"solid 1px black\" border-bottom = \"solid 1px black\"><b>Total</b></td>";
			strName += "<td table-layout = \"fixed\" width=\"20\%\" font-size=\"11\" align=\"center\" border-top = \"solid 1px black\" border-bottom = \"solid 1px black\"></td>";
			strName += "<td table-layout = \"fixed\" width=\"20\%\" font-size=\"11\" align=\"center\" border-top = \"solid 1px black\" border-right = \"solid 1px black\" border-bottom = \"solid 1px black\">"+total+"</td>";
			strName += "</tr>";
			strName += "</table>";
		...
		function GetSearchResults1(filters,columns) {
			var results1 = nlapiSearchRecord('item', 'customsearchinventory_noninventroy_item', filters, columns);
			return results1;
		}
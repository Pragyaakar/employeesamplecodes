...
function updtEmpQta(request, response)
{
  ...
  var amtonQuota= request.getParameter('quota_amt_emp');
	nlapiLogExecution('DEBUG', 'aftr submit', "  amtonQuota  ==" + amtonQuota);
...
// findCR(salesRep,Year,recId);
	...
	/*if(transItemSearch.length >=1000)
		{*/
            ...
            params['custscript_emp_quota_creation']=amtonQuota;//amtonQuota

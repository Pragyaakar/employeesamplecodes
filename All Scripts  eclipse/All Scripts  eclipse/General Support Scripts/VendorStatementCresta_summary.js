...
function suiteletSummaryVendorStatement(request, response)
{
...
//================================Subsidiary Address==================================					
 ...
 //=========================================Vendor Address=====================================
  //  var vendor_deatil = nlapiLookupField('vendor',vendor_a,'entityid');
   ...
   // for (var z = 0; z < vendor_a.length; z++) 
	    ...
	    /*    strName += "<table  width=\"100\%\">";
			...
			*/
			...
			strName += "<td width = \"20\%\"  align=\"left\" font-size=\"10\"><br/></td>";
			strName += "<td width = \"18\%\"  align=\"right\" style=\" white-space: nowrap;\" font-size=\"17.5\"><br/><b>Vendor Statement</b></td>";
			strName += "</tr>";	
			strName += "</table>";
			...
			strName += "<td width = \"45\%\"  align=\"left\" style=\" white-space: nowrap;\" font-size=\"10\"><b>"+venText+"</b></td>";
			strName += "</tr>";
	...
	strName += "<table width=\"100\%\">";
	strName += "<tr>";
	strName += "<td border-top=\"solid 1px black\" border-bottom=\"solid 1px black\" width = \"30\%\"  align=\"center\"><b>Posting Date</b></td>";	
	strName += "<td border-top=\"solid 1px black\" border-bottom=\"solid 1px black\" width = \"20\%\"  align=\"center\"><b>Invoice</b></td>";	
	strName += "<td border-top=\"solid 1px black\" border-bottom=\"solid 1px black\" width = \"20\%\"  align=\"center\"><b>Date</b></td>";
	strName += "<td border-top=\"solid 1px black\" border-bottom=\"solid 1px black\" width = \"20\%\"  align=\"center\"><b>FCY</b></td>";
	strName += "<td border-top=\"solid 1px black\" border-bottom=\"solid 1px black\" width = \"20\%\"  align=\"center\"><b>Currency</b></td>";
	strName += "<td border-top=\"solid 1px black\" border-bottom=\"solid 1px black\" width = \"20\%\"  align=\"center\"><b>LCY</b></td>";	
	strName += "<td border-top=\"solid 1px black\" border-bottom=\"solid 1px black\" width = \"20\%\"  align=\"center\"><b>Transaction<br/>Type</b></td>";
	strName += "<td border-top=\"solid 1px black\" border-bottom=\"solid 1px black\" width = \"25\%\"  padding-left=\"1em\" align=\"center\"><b>Realized<br/>Loss/Gain</b></td>";
	strName += "<td border-top=\"solid 1px black\" border-bottom=\"solid 1px black\" width = \"25\%\"  align=\"center\" padding-left=\"1em\"><b>Unrealized<br/>Loss/Gain</b></td>";
	strName += "</tr>";
	
	
    strName += "<tr>";
	strName += "<td  width = \"20\%\" style=\" white-space: nowrap;\"  align=\"center\"><b>On:"+convertDate1(start,dateformat)+"</b></td>";	
	strName += "<td  width = \"20\%\"  align=\"right\"><b></b></td>";
	strName += "<td  width = \"20\%\" style=\" white-space: nowrap;\"  align=\"center\"><b>Open Balance:</b></td>";	
	strName += "<td  width = \"20\%\" style=\" white-space: nowrap;\"  align=\"center\"><b>"+parseFloat(openingBalance).toFixed(2)+"</b></td>";
	strName += "<td  width = \"20\%\"  align=\"center\"><b></b></td>";	
	strName += "<td  width = \"20\%\" style=\" white-space: nowrap;\"  align=\"center\"><b>"+parseFloat(openingBalanceFx).toFixed(2)+"</b></td>";
	strName += "<td  width = \"20\%\"  align=\"center\"><b></b></td>";	
	...
	if (searchResults != null && searchResults != '')
	{
		...
		// nlapiLogExecution('DEBUG', 'ScheduleTest', 'search result length = ' + length);
			...
			//	nlapiLogExecution('DEBUG', 'ScheduleTest', 'foreignAmount = ' + foreignAmount);
				...
				if (type == 'VendPymt' || Status == 'open') 
				{
					 strName += "<tr>";
						
						if (date != null && date != '' && date != undefined) 
						{
							strName += "<td  width = \"20\%\" padding-left=\"1em\"  align=\"center\" style=\" white-space: nowrap;\">"+convertDate1(date,dateformat)+"</td>";
						}
						else 
						{
							date =' ';
						...
						{
							strName += "<td  width = \"20\%\" padding-left=\"1em\"  align=\"center\" style=\" white-space: nowrap;\">"+transactionnumber+"</td>";
						}
						else 
						{
							transactionnumber =' ';
						...
						if (date != null && date != '' && date != undefined) 
						{
							strName += "<td  width = \"20\%\" padding-left=\"1em\"  align=\"center\">"+convertDate1(date,dateformat)+"</td>";
						}
						else 
						{
							date =' ';
						...
						{
							strName += "<td  width = \"20\%\" padding-left=\"1em\"  align=\"center\" style=\" white-space: nowrap;\">"+parseFloat(value9).toFixed(2)+"</td>";
						}
						else 
						{
						 value9 =' ';
						...
						{
							currency = ' ';
							strName += "<td  width = \"20\%\" padding-left=\"1em\" align=\"center\" style=\" white-space: nowrap;\">"+currency+"</td>";
						}
						else 
						{
						...
						{
							value11 =' ';
							strName += "<td  width = \"20\%\"  padding-left=\"1em\" align=\"center\" style=\" white-space: nowrap;\">"+parseFloat(value11).toFixed(2)+"</td>";
				        }
						else 
						{
							strName += "<td  width = \"20\%\" padding-left=\"1em\"  align=\"center\" style=\" white-space: nowrap;\">"+parseFloat(value11).toFixed(2)+"</td>";
						...
						{
							type =' ';
							strName += "<td  width = \"20\%\" padding-left=\"1em\"  align=\"center\" style=\" white-space: nowrap;\">"+type+"</td>";
				        }
						else 
						{
							if(type=='VendBill')
							{
								type='Vendor Bill';
								strName += "<td  width = \"20\%\"  align=\"center\"  padding-left=\"1em\" style=\" white-space: nowrap;\">"+type+"</td>";
							}
							...
							{
								type='Vendor Credit';
								strName += "<td  width = \"20\%\"  align=\"center\"  padding-left=\"1em\" style=\" white-space: nowrap;\">"+type+"</td>";    //FxReval
							}
						...
						if (type == 'Vendor Payment') 
						{
							...
							strName += "<td  width = \"25\%\"  padding-left=\"1em\" align=\"center\" style=\" white-space: nowrap;\">"+parseFloat(GainOrLoss).toFixed(2)+"</td>";
				        }
						else 
						{
							strName += "<td  width = \"25\%\"  padding-left=\"1em\" align=\"center\" style=\" white-space: nowrap;\"></td>";
						}
						...
						if (Status == 'open') 
						{
							...
							strName += "<td  width = \"25\%\"  align=\"center\" style=\" white-space: nowrap;\">"+parseFloat(GainOrLoss).toFixed(2)+"</td>";
				        }
						else 
						{
							strName += "<td  width = \"25\%\"  align=\"center\" style=\" white-space: nowrap;\"></td>";
						}
	 ...
	 var last_debit=Math.round(fin_debit * 100) / 100;
	  ...
	  var EndBal = formatNumber(bal);
		  ...
		  /*strName += "<tr>";
			...
			strName += "<tr>";
			strName += "<td border-top=\"solid 1px black\" border-bottom=\"solid 1px black\"  width = \"20\%\"  align=\"center\" style=\" white-space: nowrap;\"><b>Balance as On:"+convertDate1(today1,dateformat)+"</b></td>";	
			strName += "<td border-top=\"solid 1px black\" border-bottom=\"solid 1px black\"  width = \"20\%\"  align=\"right\"><b></b></td>";
			strName += "<td border-top=\"solid 1px black\" border-bottom=\"solid 1px black\"  width = \"20\%\"  align=\"center\"></td>";	
			strName += "<td border-top=\"solid 1px black\" border-bottom=\"solid 1px black\" width = \"20\%\"  align=\"center\"><b>"+parseFloat(closing_bal).toFixed(2)+"</b></td>";
			strName += "<td border-top=\"solid 1px black\" border-bottom=\"solid 1px black\" width = \"20\%\"  align=\"right\"><b></b></td>";
			strName += "<td border-top=\"solid 1px black\" border-bottom=\"solid 1px black\" width = \"20\%\"  align=\"center\"><b>"+parseFloat(closing_bal_foreignAmount).toFixed(2)+"</b></td>";
			if (DebitAmount == null && DebitAmount == '' && DebitAmount == undefined && DebitAmount == 'NaN' ) 
			{
				
				DebitAmount ='0';
					strName += "<td border-top=\"solid 1px black\" border-bottom=\"solid 1px black\" width = \"20\%\"  align=\"center\"><b></b></td>";
   ...
   catch(e){throw nlapiCreateError('SUITELET_ERROR',"There is No data Available for this Transaction...", false);  }

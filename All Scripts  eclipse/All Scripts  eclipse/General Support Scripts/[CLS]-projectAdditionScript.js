...
function gatherSavedSearchData_2(filters){
	...
	if(!isEmpty(searchResult)){
		...
		for (var searchResultIndex = 0; searchResultIndex < searchResult.length; searchResultIndex++) {
			...
			var project = searchResult[searchResultIndex].getValue("companyname","job");
			...
			if(searchResult2Map[customer+'_'+orderNumber+'_'+documentNumber]){
			 ...
			 if(project !=null && project!='' && project !=undefined && project != '- None -')
				{
...
if(user =='12729')
{
	...
	if(!isEmpty(searchResult)){
		...
		//	var tranType = searchResult[searchResultIndex].getText(new nlobjSearchColumn("type",null,"GROUP"));
			...
			var project = searchResult[searchResultIndex].getValue("companyname","job","GROUP");
			...
			if(salesRepMap[salesRep]){
				...
				var projectMap = {};
				projectMap = tempSalesRepMap['project'];
				...
				tempCustomerMap = customerMap[customer]; //Customer Map
				 ...
				 //================================================================
					if(projectMap[project]){ //Customer is present
						var tempProjectMap = {};
						tempProjectMap = projectMap[project]; //Customer Map
						
						 var orderMap_ = {};
						 orderMap_ = tempProjectMap['orders'];
						 ...
						 var orderMap_trans = {};
							...
							orderMap_trans_arr.push(orderMap_trans);
							 ...
							 if(!isEmpty(amount)){
								...
								// handle Customer Total
								var tempProjectTotal = {};
								tempProjectTotal = tempProjectMap['project_total'];
								
								tempProjectTotal['project_total_income'] = (tempProjectTotal['project_total_income']?tempProjectTotal['project_total_income']:0) + (orderMap_trans['income']?orderMap_trans['income']:0);
								tempProjectTotal['project_total_expense'] = (tempProjectTotal['project_total_expense']?tempProjectTotal['project_total_expense']:0) + (orderMap_trans['expense']?orderMap_trans['expense']:0)
								tempProjectTotal['project_total_gp_amount'] = (tempProjectTotal['project_total_income'] ? tempProjectTotal['project_total_income'] :0) - (tempProjectTotal['project_total_expense']?tempProjectTotal['project_total_expense']:0);
								if(tempOrderTotalMap['order_total_income'] == 0 || tempOrderTotalMap['order_total_income'] == '0' || tempOrderTotalMap['order_total_income'] == null || tempOrderTotalMap['order_total_income'] == undefined || tempOrderTotalMap['order_total_income'] == '' ){
									tempOrderTotalMap['order_total_gp_percent'] ='';
								}
								else{
									tempProjectTotal['project_total_gp_percent'] = (tempProjectTotal['project_total_gp_amount']?tempProjectTotal['project_total_gp_amount']:0) / (tempProjectTotal['project_total_income']?tempProjectTotal['project_total_income']:1)*100;
								}
								tempProjectMap['project_total'] = tempProjectTotal;
								// Handle Sales Rep Total
								 var tempSalesRepTotal = {};
								 tempSalesRepTotal = tempSalesRepMap['salesRep_total'];
							 ...
							 var orderMap = {};
								...
								orderMap_[orderNumber] = orderMap;
								 ...
								 //============================= project ================
								 tempProjectMap['orders'] = orderMap_;
								 var tempProjectTotal = {};
								 tempProjectTotal = tempProjectMap['customer_total'];
								 tempProjectTotal['project_total_income'] = (tempProjectTotal['project_total_income']?tempProjectTotal['project_total_income']:0) + (tempOrderTotalMap['order_total_income']?tempOrderTotalMap['order_total_income']:0);
								 tempProjectTotal['project_total_expense'] = (tempProjectTotal['project_total_expense']?tempProjectTotal['project_total_expense']:0) + (tempOrderTotalMap['order_total_expense']?tempOrderTotalMap['order_total_expense']:0);
								 tempProjectTotal['project_total_gp_amount'] = (tempProjectTotal['project_total_income'] ? tempProjectTotal['project_total_income'] :0) - (tempProjectTotal['project_total_expense']?tempCustomerTotal['customer_total_expense']:0);
									
									if(tempProjectTotal['project_total_income'] == 0 || tempProjectTotal['project_total_income'] == '0' || tempProjectTotal['project_total_income'] == null || tempProjectTotal['project_total_income'] == undefined || tempProjectTotal['project_total_income'] == '' ){
										tempProjectTotal['project_total_gp_percent'] ='';
									}
									else{
										tempProjectTotal['project_total_gp_percent'] = (tempProjectTotal['project_total_gp_amount']?tempProjectTotal['project_total_gp_amount']:0) / (tempProjectTotal['project_total_income']?tempProjectTotal['project_total_income']:1)*100;
									}
								 tempProjectMap['customer_total'] = tempProjectTotal;
								 
								 
								 projectMap[project] =  tempProjectMap;
				 ...
				 //===============================================================
					...
					tempProjectMap['orders'] = orderMap_;
					var tempProjectTotal = {};
					tempProjectTotal['project_total_income'] = (tempOrderTotalMap['order_total_income']?tempOrderTotalMap['order_total_income']:0);
					tempProjectTotal['project_total_expense'] = (tempOrderTotalMap['order_total_expense']?tempOrderTotalMap['order_total_expense']:0);
					tempProjectTotal['project_total_gp_amount'] = (tempProjectTotal['project_total_income'] ? tempProjectTotal['project_total_income'] :0) - (tempProjectTotal['project_total_expense']?tempProjectTotal['project_total_expense']:0);
					...
					tempProjectMap['project'] = project;
					//tempVendorMap['vendor_name'] = vendor_txt;
		...
		// form
		 ...
		 html += '<body bgcolor="#FFFFFF" class="body_2010 nl-pagetint " link="#000000" vlink="#000000" alink="#000000" text="#000000" style="background-image:none;margin: 5px 0px 5px 0px;">';
		    ...
		    if(!isEmpty(dataMap)){
		    	...
		    	nlapiLogExecution('DEBUG','salesRepMap', JSON.stringify(salesRepMap));

					...
					if(type == 'create') //|| type == 'edit'
					{
						try
						{
							...
							if(transObj != null && transObj != undefined && transObj != '')
							{
							   ...
							   nlapiLogExecution('DEBUG','AutoNumbering','tranDate =='+ tranDate);
								...
								else if(recType =='customrecord_mo_maintenance_order')
								{
									checkType=5;
									
									 subsi = nlapiGetFieldValue('custrecord_mo_subsidiary');
									 nlapiLogExecution('DEBUG','AutoNumbering','Maintenance subsi =='+ subsi);
									
								}
								else if(recType =='customrecord_guest_registration_form')
								{
									checkType=6;
									
									subsi = nlapiGetFieldValue('custrecordguest_subsidiary');
									nlapiLogExecution('DEBUG','AutoNumbering','registration subsi =='+ subsi);
						...
						//=======================================================		
							  ...
							  if(prefix != null && prefix != undefined && prefix != '')
							  {
								  ...
								  var d = new Date();
								  var n = d.valueOf();
								  if(n != null && checkType != 5 && checkType != 6)
								  {
								  ...
								  else if( n != null && (checkType == 5 ||checkType == 6))
								  {
									  nlapiSubmitField(recType, recID,'name',value);

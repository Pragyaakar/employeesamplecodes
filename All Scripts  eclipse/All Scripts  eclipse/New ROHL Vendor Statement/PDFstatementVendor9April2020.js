	function suiteletPdfVendorStatement(request,response)
	{
		...
		if(subsidiary)
		{
			var subsiObj = nlapiLoadRecord('subsidiary',subsidiary);
			 ...
			 SubsiLogo = subsiObj.getFieldValue('logo'); 
		...
		var amtDue = venRecord.getFieldValue('balance');
		 ...
		 var numberOfAddress = venRecord.getLineItemCount('addressbook');
		   ...
		   var openingBalance = getOpeningBalance(vendor, locationname, startdate,subsidiary);
		   ...
		   var companyinfo = nlapiLoadConfiguration('companyinformation');
			...
			var url = 'https://5250730.app.netsuite.com/core/media/media.nl?id=4678&c=5250730&h=46c40034857ab3c025fa'; 
		strName += "<table width=\"100\%\">";
		strName += "<tr>";
		strName += "<td>";
		strName +="<img height='60' width='150' src=\""+nlapiEscapeXML(url)+"\"></img>";//(SubsiLogo)
		strName += "</td>";
		...
		strName += "<td width = \"20\%\"  align=\"left\" font-size=\"10\"><b>Address</b><br/>"+nlapiEscapeXML(SubsiAdd)+"</td>";
		...
		strName += "<td  background-color = \"#DEDBDB\" align = \"center\" font-size=\"9\" border-bottom=\"solid 1px black\" border-top=\"solid 1px black\" border-left=\"solid 1px black\" width=\"27\%\"><b>Bill No</b></td>";
		strName += "<td  background-color = \"#DEDBDB\" align = \"center\" font-size=\"9\" border-bottom=\"solid 1px black\" border-top=\"solid 1px black\" border-left=\"solid 1px black\" width=\"27\%\"><b>Bill Date</b></td>";
		...
		if (searchResults != null && searchResults != '')
		{
			...
			nlapiLogExecution('DEBUG', 'ScheduleTest', 'search result length = ' + length);
				...
				for (var i = 0;  i < searchResults.length; i++) 
				{
					...
					var value8 = searchResults[i].getValue('custbody_bill_number');
					var BillNo = value8;
					nlapiLogExecution('DEBUG', 'ScheduleTest', 'BillNo = ' + BillNo);
					
					var value9 = searchResults[i].getValue('custbody_bill_date');
					var billDate = value9;
					...
					if ( i >= 900) {
					 ...
					 strName += "<tr>";
						...
						{
							strName += "<td align = \"center\" font-size=\"9\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"27\%\">"+billDate+"</td>";
						}
						else 
						{
							billDate =' ';
	...
	function getOpeningBalance(vendor, locationname, start,subsidiary)
	{

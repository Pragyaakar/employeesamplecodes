				...
				var startdate_obj = nlapiStringToDate(startdate)
						...
						if (startdate_obj <= enddate_obj) 
						{
							...
							//alert('nlapiSubmitRecord set'+venstatsubmitid)
					    		...
					    		var url = nlapiResolveURL('SUITELET', 'customscript_pdf_page_vendor_statement', 'customdeploy_pdf_page_vendor_statement');
					        	 url = url + '&venstatsubmitid=' + venstatsubmitid+'&ven_subsi='+subsidiary;

...
function approvalChkForPostSource(type,name)
{
	 ...
	 if(type == 'item' && name == 'item') 
    {
		...
		var cust  = nlapiGetLineItemValue('item','customer','1');
		//alert('cust is'+cust);
		  ...
		  if(item!=null && item != '')
		  {
      	 ...
      	 if(cust != null && cust != undefined && cust !='')
      	 {
      		 nlapiSetCurrentLineItemValue('item','customer',cust);
      	 }
			    	...
			    	if(projId == projName )
			    	{
                      ...
                      else
                      {
				    	...
				    	if(approvRequi == 'F')
				    	{
				    		nlapiSetCurrentLineItemValue('item','custcol_vad_pr_apprreq',approvRequi);
                            nlapiSetCurrentLineItemValue('item','custcol_vad_appstatus','5');
                            nlapiSetCurrentLineItemValue('item','custcol_vbpl_status_approved','1');
				    	}

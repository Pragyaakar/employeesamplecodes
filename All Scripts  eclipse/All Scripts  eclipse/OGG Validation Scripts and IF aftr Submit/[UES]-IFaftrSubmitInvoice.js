	 ...
	 try
	  {
		...
		// var recipientLook = nlapiLookupField('invoice',invoiceID,'email');
		 ...
		 if(emailRecipient !=null && emailRecipient !='' && emailRecipient!=undefined)
		 {
	         ...
	         var body ="<!DOCTYPE html><html><body><img src='"+Logo+"' width='100' height='100'><br>"+Logo+"<br><br> "+" Dear "+CustomerName+", <br><br>"+"Your order has been processed and is on its way to you. <br><br> Please track the progress of your order here "+trckingNoLink+".<br><br>Thank you for shopping with "+Name+".<br><br><br> Best Regards,<br>"+Name+" Team.<br></body></html>";
	         var records=[];

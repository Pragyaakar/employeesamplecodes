				...
				for(var i=0;i<resultSet.length;i++)//resultSet.length
					{
						...
						var weightedPIPEAmt =findTransaction2(date,RecID);
						
						SecondAmt.push(weightedPIPEAmt);
						
						var WonweightedPIPEAmt =findTransaction3(date,RecID);
						ThirdAmt.push(WonweightedPIPEAmt);
						
						var fullPIPEAmt =findTransaction4(date,RecID);
...
function findTransaction2(date,RecID)
{
...
function findTransaction3(date,RecID)
{
...
function findTransaction4(date,RecID)
{

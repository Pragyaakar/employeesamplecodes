    ...
    recObj = nlapiLoadRecord(recType,recId);
	 ...
	 var subsidiary = recObj.getFieldValue('subsidiary');
	  ...
	  nlapiLogExecution('DEBUG', 'aftr submit', "  PRlinecount  ==" + PRlinecount);
		...
		createSalesOrderForPR(PRlinecount,date,custUniq,vendArr,amtArr,line_chkArr,Class,Department,locationArray,rateArray,recId,itemArray,qtyArray,unitArray,descriptionArray,subsidiary,recId,recType);//amount,
		
}	
	
	
function createSalesOrderForPR(PRlinecount,date,custUniq,vendArr,amtArr,line_chkArr,Class,Department,locationArray,rateArray,recId,itemArray,qtyArray,unitArray,descriptionArray,subsidiary,recId,recType)	
{	

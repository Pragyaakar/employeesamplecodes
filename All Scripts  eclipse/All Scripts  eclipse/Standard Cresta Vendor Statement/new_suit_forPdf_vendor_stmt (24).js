...
function suiteletTestLayout(request, response)
{
 ...
 try
 {
	...
	venstatid =request.getParameter('venstatsubmitid'); 
	 var IsExcel =request.getParameter('excl'); 
 ...
 //=========================================Vendor Address=====================================
  //  var vendor_deatil = nlapiLookupField('vendor',vendor_a,'entityid');
     ...
     // nlapiLogExecution('DEBUG','before submit','numberOfAddress =='+numberOfAddress);
      ...
      var CurrencyList = s1.getLineItemCount('currency');
	   for (var x2 = 1; x2 <= CurrencyList; x2++)
	   {
		var lineCur =s1.getLineItemValue('currency', 'currency', x2);
		
		var lineCur1 =s1.getLineItemText('currency', 'currency', x2);
    ...
    for (var z = 0; z < CurrencyListArr.length; z++) 
					{
						...
						if (vendor != null && vendor != '' && vendor != undefined) 
						{
							...
							//	var openingBalance = getOpeningBalance(vendor, locationname, custCreatedDate, opBalanceEndDate,CurrencyListArr[z]);
								var openingBalanceFx = getOpeningBalance1(vendor, locationname, custCreatedDate, opBalanceEndDate,CurrencyListArr[z],subsidiary);
							/*	
	...
	strName += "<table width=\"100\%\">";
    strName += "<tr>";
	strName += "<td  width = \"50\%\" colspan=\"6\" align=\"left\" margin-top=\"10px\"><b>Start Date :</b>&nbsp;"+start+"</td>";//convertDate1(start,dateformat)
	strName += "</tr>";
	strName += "<tr>";
	strName += "<td  width = \"50\%\" colspan=\"6\" align=\"left\"><b>End Date :</b>&nbsp;"+end+"</td>";//convertDate1(end,dateformat)
	strName += "</tr>";
	strName += "<tr>";
	strName += "<td  width = \"50\%\" colspan=\"6\" align=\"left\"><b>Payment Terms :</b>&nbsp;"+vendor_terms+"</td>";	
	strName += "</tr>";
	strName += "<tr>";
	strName += "<td  width = \"50\%\" colspan=\"6\" align=\"left\" margin-bottom=\"10px\"><b>Currency :</b>&nbsp;"+CurrencyListArr1[z]+"</td>";	
	strName += "</tr>";
	strName += "</table>";
	
	strName += "<table width=\"100\%\">";
	strName += "<tr>";
	strName += "<td border-top=\"solid 1px black\" border-bottom=\"solid 1px black\" width = \"30\%\" border-left=\"solid 1px black\"  align=\"center\" border-collapse=\"collapse\" padding-left=\"2em\" padding-right=\"2em\"><b>Date</b></td>";	
	strName += "<td border-top=\"solid 1px black\" border-bottom=\"solid 1px black\" width = \"20\%\" border-left=\"solid 1px black\"  align=\"center\" border-collapse=\"collapse\" padding-left=\"2em\" padding-right=\"2em\"><b>Transaction Type</b></td>";	
	strName += "<td border-top=\"solid 1px black\" border-bottom=\"solid 1px black\" width = \"20\%\" border-left=\"solid 1px black\"  align=\"center\" border-collapse=\"collapse\" padding-left=\"2em\" padding-right=\"2em\"><b>Document Number</b></td>";
	...
	strName += "<td border-top=\"solid 1px black\" border-bottom=\"solid 1px black\" width = \"20\%\" border-left=\"solid 1px black\"  align=\"center\" border-collapse=\"collapse\" padding-left=\"2em\" padding-right=\"2em\" style=\" white-space: nowrap;\"><b>Transaction Currency</b></td>";
	strName += "<td border-top=\"solid 1px black\" border-bottom=\"solid 1px black\" width = \"20\%\" border-left=\"solid 1px black\"  align=\"center\" border-collapse=\"collapse\" padding-left=\"2em\" padding-right=\"2em\" border-right=\"solid 1px black\" style=\" white-space: nowrap;\"><b>Amount</b></td>";	
	/*strName += "<td border-top=\"solid 1px black\" border-bottom=\"solid 1px black\" width = \"20\%\" border-left=\"solid 1px black\"  align=\"center\" border-collapse=\"collapse\" padding-left=\"2em\" padding-right=\"2em\"><b></b></td>";
	...
	*/
	...
	strName += "<td  width = \"20\%\"  padding-left=\"2em\" padding-right=\"2em\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" border-right=\"solid 1px black\" style=\" white-space: nowrap;\"  align=\"center\" border-collapse=\"collapse\"><b>"+formatNumber(parseFloat(openingBalanceFx).toFixed(2))+"</b></td>";
	/*strName += "<td  width = \"20\%\"  padding-left=\"2em\" padding-right=\"2em\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\"  align=\"center\"><b></b></td>";	
	strName += "<td  width = \"20\%\"  padding-left=\"2em\" padding-right=\"2em\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\"  align=\"center\"><b></b></td>";	
	...
	*/
	...
	filters.push(new nlobjSearchFilter('currency', null, 'anyof', CurrencyListArr[z]));
	...
	//var searchResults = nlapiSearchRecord('transaction', 'customsearch_cresta_vendorstatement', filters, columns);
	 ...
	 var searchResults = getSavedSearchResult(null, 'customsearch_cresta_vendorstatement', filters);
	...
	if (searchResults != null && searchResults != '')
	{
		...
		// nlapiLogExecution('DEBUG', 'ScheduleTest', 'search result length = ' + length);
			...
			//	nlapiLogExecution('DEBUG', 'ScheduleTest', 'custbody_cust_particulars = ' + particulars);
				...
				var value9 = searchResults[i].getValue('fxamount');
			...
			/*	var remainingUsage = nlapiGetContext().getRemainingUsage();
				...
				*/
				     ...
				     {
				    	 strName += "<td  width = \"30\%\"  padding-left=\"2em\" padding-right=\"2em\" style=\" white-space: nowrap;\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" align=\"center\" border-collapse=\"collapse\">"+date+"</td>";	//convertDate1(start,dateformat)
					 ...
					 {
				 	     strName += "<td  width = \"20\%\"  padding-left=\"2em\" padding-right=\"2em\"  border-bottom=\"solid 1px black\"   align=\"right\" border-left=\"solid 1px black\">"+transactionnumber+"</td>";
					  }
				     else
				     {
				    	 transactionnumber='';
				     ...
				     if (currency == null && currency == '' && currency == undefined && currency == 'NaN' ) 
				       ...
				       if (parseFloat(value9) != null && parseFloat(value9) != '' && parseFloat(value9) != undefined ) 
						{
				    	 //  nlapiLogExecution('DEBUG', 'getOpeningBalance', 'parseFloat(value9) = ' + parseFloat(value9)+  '  formatnnum='+formatNumber(parseFloat(value9).toFixed(2)));
							strName += "<td  width = \"20\%\" padding-left=\"2em\" padding-right=\"2em\" border-bottom=\"solid 1px black\" border-right=\"solid 1px black\" border-left=\"solid 1px black\"  align=\"center\" style=\" white-space: nowrap;\" border-collapse=\"collapse\">"+formatNumber(parseFloat(value9).toFixed(2))+"</td>";
						}
						else 
						{
						 value9 =0.00;
							strName += "<td  width = \"20\%\" padding-left=\"2em\" padding-right=\"2em\" border-bottom=\"solid 1px black\" border-right=\"solid 1px black\" border-left=\"solid 1px black\" align=\"center\" style=\" white-space: nowrap;\" border-collapse=\"collapse\">"+parseFloat(value9).toFixed(2)+"</td>";
						}
      ...
      var closing_bal_foreignAmount = parseFloat(openingBalanceFx)+parseFloat(foreignAmount);
	  var EndBal = formatNumber(parseFloat(closing_bal_foreignAmount).toFixed(2));
	   
 
			strName += "<tr>";
			strName += "<td  border-bottom=\"solid 1px black\"  width = \"30\%\" border-left=\"solid 1px black\"  align=\"center\" style=\" white-space: nowrap;\" padding-left=\"2em\" padding-right=\"2em\"><b>Balance as On:"+today1+"</b></td>";	//convertDate1(today1,dateformat)
			...
			strName += "<td  border-bottom=\"solid 1px black\" width = \"20\%\" border-left=\"solid 1px black\"  align=\"right\" padding-left=\"2em\" padding-right=\"2em\"><b></b></td>";
			strName += "<td  border-bottom=\"solid 1px black\" width = \"20\%\" border-left=\"solid 1px black\" border-right=\"solid 1px black\" align=\"center\" padding-left=\"2em\" padding-right=\"2em\"><b>"+EndBal+"</b></td>";
			...
			strName += "</tr>";
				...
				else if(searchResults == null || searchResults == '' || searchResults ==undefined)
				{
					...
					if(parseFloat(openingBalanceFx) != null && parseFloat(openingBalanceFx) !='')
					{
						FinalBalance=parseFloat(openingBalanceFx);
					}
					else 
					{
					...
					strName += "<td  border-bottom=\"solid 1px black\"  width = \"20\%\" border-left=\"solid 1px black\"  align=\"right\" padding-left=\"2em\" padding-right=\"2em\"><b></b></td>";
					strName += "<td  border-bottom=\"solid 1px black\"  width = \"20\%\" border-left=\"solid 1px black\"  align=\"center\" padding-left=\"2em\" padding-right=\"2em\"></td>";	
					//strName += "<td  border-bottom=\"solid 1px black\" width = \"20\%\" border-left=\"solid 1px black\"  align=\"center\" padding-left=\"2em\" padding-right=\"2em\"><b>"+parseFloat(0.00).toFixed(2)+"</b></td>";
					strName += "<td  border-bottom=\"solid 1px black\" width = \"20\%\" border-left=\"solid 1px black\"  align=\"right\" padding-left=\"2em\" padding-right=\"2em\"><b></b></td>";
					strName += "<td  border-bottom=\"solid 1px black\" width = \"20\%\" border-right=\"solid 1px black\" border-left=\"solid 1px black\"  align=\"center\" padding-left=\"2em\" padding-right=\"2em\"><b>"+formatNumber(parseFloat(FinalBalance).toFixed(2))+"</b></td>";
...
'</head>';
	...
	var xlsFile = nlapiCreateFile('Vendor Statement.xls', 'EXCEL', nlapiEncrypt(xml, 'base64'));

	xlsFile.setFolder(94);
	var fileID = nlapiSubmitFile(xlsFile);		
	var file = nlapiLoadFile(fileID);
	//nlapiLogExecution('DEBUG', 'suiteletGenerateDeliveryAdvice', 'file = '+file );
	var pdfName =  'Vendor Statement.xls';         
...
function getOpeningBalance(vendor, locationname, openingBalanceDate, opBalanceEndDate,currency,subsidiary)
{
		/*		nlapiLogExecution('DEBUG', 'getOpeningBalance', 'vendor = ' + vendor);
			...
			*/	
				...
				totalAmount = parseFloat(totalAmount);
				 ...
				 filters[2] = new nlobjSearchFilter ('currency', null, 'anyof',currency);
				var searchresults = nlapiSearchRecord('transaction','customsearch_cresta_vendorstatement',filters,columns)
...
function getOpeningBalance1(vendor, locationname, openingBalanceDate, opBalanceEndDate,currency,subsidiary)
{
		/*		nlapiLogExecution('DEBUG', 'getOpeningBalance', 'vendor = ' + vendor);
				nlapiLogExecution('DEBUG', 'getOpeningBalance', 'locationname = ' + locationname);
				nlapiLogExecution('DEBUG', 'getOpeningBalance', 'openingBalanceDate = ' + openingBalanceDate);
			...
			*/	
			...
			//	var searchresults = nlapiSearchRecord('transaction','customsearch_cresta_vendorstatement',filters,columns)
				...
				var getOpeningBalancefunction1 = parseFloat(totalAmount);
				 ...
				 nlapiLogExecution('DEBUG', 'getOpeningBalance', 'getOpeningBalancefunction = ' + getOpeningBalancefunction1);

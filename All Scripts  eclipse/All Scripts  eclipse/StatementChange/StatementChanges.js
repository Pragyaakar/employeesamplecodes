		 ...
		 * 1.00       07 May 2019     Priyanka Patil
		 *
		 */
		 ...
		 */
			function suiteletStatement(request,response)
			{
				...
				var zip ;
				 ...
				 var payWithinRange =  getOpeningBalancePaymentWithin(customer, startdate, enddate,subsidiary)
					...
					transItemSearch1 = findTransaction1(searchId1,customer,startdate,enddate,subsidiary);
					transItemSearch2 = findTransaction2(searchId2,customer,startdate,enddate,subsidiary);
				    transItemSearch3 = findTransaction3(searchId3,customer,startdate,enddate,subsidiary);
		    ...
		    var columnPay =0;
		      ...
		      for(var l=0;l<jsonArray5.length;l++)
				 {
		    	  ...
		    	  var zero =0;
			                 	if(jsonArray5[l].inv_amount != null && jsonArray5[l].inv_amount != undefined && jsonArray5[l].inv_amount != ' ' &&  jsonArray5[l].inv_amount > 0)
									{
		      ...
		      var BalTotal2 = parseFloat(BalTotal1) + parseFloat( openBalanceWithPayMent );
				...
				strName += "<td width = \"10\%\"  align=\"left\" font-size=\"12\"></td>";
				strName += "<td width = \"40\%\"  align=\"left\" font-size=\"10\"><br/><b>Start Date</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+startdate+"<br/><b> As of Date</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+enddate+"<br/><b>Amount Due</b>&nbsp;&nbsp;&nbsp;&nbsp;"+tp+"<br/><b>Currency</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+currency+"<br/></td>";
				...
				//-----------------------------Fetch Values-------------------------------------------
				 for(var l=0;l<jsonArray5.length;l++)
				 {
					...
					// nlapiLogExecution('DEBUG', 'aftr submit', "  Trans Number ==" +jsonArray5[l].tranid  ); 
						         ...
						         strName += "<td align = \"center\" font-size=\"9\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"30\%\">"+jsonArray5[l].tranid+"</td>";
						             ...
						             else if(jsonArray5[l].inv_amount != null && jsonArray5[l].inv_amount != undefined && jsonArray5[l].inv_amount != ' ' && jsonArray5[l].inv_amount < 0)
									{
						            	 if(jsonArray5[l].inv_amount == 0)
						                	...
						                	{
						                		var s ='NA*';
						                		strName += "<td align = \"center\" font-size=\"9\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"30\%\">"+formatNumber(s)+"</td>";
						                		jsonArray5[l].invpay_amount = jsonArray5[l].inv_amount;
						                		jsonArray5[l].inv_amount =0;
						                	}
						             ...
						             else
						             {
						                ...
						                if(jsonArray5[l].inv_amount != null && jsonArray5[l].invpay_amount != null && jsonArray5[l].invpay_amount > 0)
						                {
						                	 var balance = parseFloat(jsonArray5[l].inv_amount) - parseFloat( jsonArray5[l].invpay_amount );
						                }
						                else if(jsonArray5[l].inv_amount != null && jsonArray5[l].invpay_amount != null && jsonArray5[l].invpay_amount < 0)
						                {
						                	 var balance = parseFloat(jsonArray5[l].invpay_amount) - parseFloat( jsonArray5[l].inv_amount );
						                }
						                else
						                {
								     ...
								     if(jsonArray5[l].invpay_amount != null && jsonArray5[l].invpay_amount < 0)
					                 {
								      PayTotal2 = parseFloat(PayTotal2) + parseFloat(jsonArray5[l].invpay_amount) ;
					                 } 
				 ...
				 finPayTot = parseFloat(PayTotal) + parseFloat(PayTotal1)+ parseFloat(PayTotal2);
			     var FinTotal = parseFloat(openBalanceWithPayMent)+parseFloat(InvTotal) - parseFloat(finPayTot) ;
				// var  newColBal = parseFloat(openBalanceWithPayMent)+parseFloat(BalTotal);
				...
				*/
				...
				xml += "<pdf><head><macrolist><macro id=\"myfooter\"><p align=\"left\">**For all invoices which were created prior to the Start Date and for which payment was applied after the Start Date, the invoice amount will be shown as NA because it is included in the open balance.</p><p align=\"center\"><pagenumber /></p></macro></macrolist></head>\n<body size= \"A4\" header=\"nlheader\" header-height=\"0.5in\" footer=\"myfooter\" footer-height=\"0.5in\" font-size=\"10\">\n";
			...
			function findTransaction1(searchId1,customer,startdate,enddate,subsidiary)
			{
			...
			function findTransaction2(searchId2,customer,startdate,enddate,subsidiary)
			{
			...
			function findTransaction3(searchId3,customer,startdate,enddate,subsidiary)
			{
			...
			function getOpeningBalance(customer, openingBalanceDate, opBalanceEndDate,subsidiary)
			{
			...
			function getOpeningBalancePaymentWithin(customer, startdate, enddate,subsidiary)
			{
							...
							*/
							...
							// filters[2] = new nlobjSearchFilter ('trandate','applyingtransaction','within',startdate,enddate);
							 filters[2] = new nlobjSearchFilter ('formuladate',null,'within',startdate,enddate);
                                      ...
                                      nlapiLogExecution('DEBUG', 'getOpeningBalancePaymentWithin of  searchresults.length ', 'searchresults.length = ' + searchresults.length );
									   ...
									   var internalID = '';
						    			...
						    			for (var i = 0;  i < searchresults.length; i++) 
						    			{
						    				...
						    				var value1 = searchresults[i].getValue("formulacurrency",null,"SUM");	
						    				amount += parseFloat(value1);

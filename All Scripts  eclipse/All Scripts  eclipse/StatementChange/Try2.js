		 ...
		 */
			function suiteletStatement(request,response)
			{
				...
				var zip ;
				 ...
				 var payWithinRange =  getOpeningBalancePaymentWithin(customer, startdate, enddate,subsidiary)
				    ...
				    var transItemSearch4 = findTransaction4(searchId4,customer,startdate,enddate,subsidiary);
				    
				    var transItemSearch5= findTransaction5(searchId5,customer,startdate,enddate,subsidiary);
					...
					// nlapiLogExecution('DEBUG', 'aftr submit', "  DocNumArr.indexOf(jsonArray5[l].tranid_apply) ==" +DocNumArr.indexOf(jsonArray5[l].tranid_apply) ); 
						         ...
						         else if(jsonArray5[l].inv_amount != null && jsonArray5[l].inv_amount != undefined && jsonArray5[l].inv_amount != ' ' && jsonArray5[l].inv_amount > 0 && jsonArray5[l].type =='Credit Memo')
						         {
						             ...
						             else
						             {
						                ...
						                if(jsonArray5[l].invpay_amount != null && jsonArray5[l].invpay_amount != undefined && jsonArray5[l].invpay_amount != '' && jsonArray5[l].invpay_amount > 0)
										{
			...
			function findTransaction4(searchId4,customer,startdate,enddate,subsidiary)
			{
			...
			function findTransaction5(searchId5,customer,startdate,enddate,subsidiary)
			{

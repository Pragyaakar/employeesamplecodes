	...
	//============================================ TAX REGISTRASTION NUM ==============================================
		...
		if((AsDateof == null || AsDateof == '' || AsDateof == undefined))
		{
		...
		//var testemail = nlapiCreateFile('Customer Statement Report', 'PDF', nlapiEncrypt(html, 'base64'));
...
*/		
		...
		nlapiSendEmail(nlapiGetUser(),'tm@aarialife.com','Customer statement',emailMsg,null,null,null,file);

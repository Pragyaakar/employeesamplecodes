	...
	if (name == 'custpage_customername')
     {
        var customer = nlapiGetFieldValue('custpage_customername');
  		if(customer)
         {
           	...
           	var bal = nlapiLookupField('customer',customer,'balance');
           	var email = nlapiLookupField('customer',customer,'email');
           	if(bal)
            {
              nlapiSetFieldValue('custpage_bal',bal);
            }
           ...
           if(email)
        	  {
        	   nlapiSetFieldValue('custpage_mail',email);
        	  }
         }
...
function clientScriptExcelEmail_createrecord()
{
...
//	var locationname = nlapiGetFieldValue('custpage_locationname'); //locationname
	...
	var AsOfDate = nlapiGetFieldValue('custpage_asofdate');
					...
					if(startdate_obj <= enddate_obj) 
						{
                         ...
                         // alert('venstatobj set'+venstatobj)
							...
							venstatobj.setFieldValue('custrecord_custstat_subsidiary', subsidiary);
								venstatobj.setFieldValue('custrecord_cust_address', addressText);				
								venstatobj.setFieldValue('custrecord_cust_statement_email', email);
							//	alert('email set'+email)
								venstatobj.setFieldValue('custrecord_custstat_currency', currency);
						...
						//	alert('user set'+user)
							...
							//alert('nlapiSubmitRecord set'+venstatsubmitid)
					    		...
					    		var url = nlapiResolveURL('SUITELET', 'customscript_sutemail_excel', 'customdeploy_sut_email_excel');
					        	 url = url + '&custscript_custmrecid=' + venstatsubmitid+'&cust_opentran='+openTran+'&cust_asdate='+AsOfDate;
...
function clientScriptPDFEmail_createrecord()
{
					...
					if(startdate_obj <= enddate_obj) 
						...
						//	alert('user set'+user)
							...
							//alert('nlapiSubmitRecord set'+venstatsubmitid)
					    		...
					    		var url = nlapiResolveURL('SUITELET', 'customscript_sut_emailpdf_layout', 'customdeploy_sut_emailpdflayout');
					        	 url = url + '&custscript_custmrecid=' + venstatsubmitid+'&cust_opentran='+openTran+'&cust_asdate='+AsOfDate;
					...
					if(startdate_obj <= enddate_obj) 
						...
						//	alert('user set'+user)
							...
							//alert('nlapiSubmitRecord set'+venstatsubmitid)
					    		...
					    		var url = nlapiResolveURL('SUITELET', 'customscript_sut_custstatementpdf', 'customdeploy_sut_custstatementpdflayout');
					        	 url = url + '&custscript_custmrecid=' + venstatsubmitid+'&cust_opentran='+openTran +'&cust_asdate='+AsOfDate;
					...
					if(startdate_obj <= enddate_obj) 
						...
						//	alert('user set'+user)
							...
							//alert('nlapiSubmitRecord set'+venstatsubmitid)
					    		...
					    		var url = nlapiResolveURL('SUITELET', 'customscript_sut_custstatementexcel', 'customdeploy_sut_custstatementexcel');
					        	 url = url + '&custscript_custmrecid=' + venstatsubmitid+'&cust_opentran='+openTran+'&cust_asdate='+AsOfDate;

	function suiteletStatement(request,response)
	{
	  	try
	  	{
			...
			var enddate;
			var subsidiary;
			var opentran =request.getParameter('cust_opentran');//cust_asdate
	...
	//============================================ TAX REGISTRASTION NUM ==============================================
				...
				var zip ='';
				   ...
				   for (var z = 0; z < CurrencyListArr.length; z++) 
				   {
						...
						else if(subsidiary==15)
						{
							...
							strName += "<td colspan =\"8\" width = \"100\%\"  align=\"center\" font-size=\"16\" margin-top=\"30px\"><b>CUSTOMER STATEMENT</b></td>";
							strName += "</tr>";
							strName += "</table>";
						...
						strName += "<tr>";
						strName += "<td font-size=\"10\" style=\"border-left:1px;border-top:1px;border-bottom:1px;border-right:1px;background-color:#CCCCCC;text-align:left;\" >Statement</td>";	
						strName += "</tr>"	;
						strName += "<tr>";
						...
						strName += "<tr>";
						strName += "<td style=\"border-left:1px;border-bottom:1px;border-right:1px;\" width = \"6\%\"  align=\"left\" font-size=\"10\">"+nlapiEscapeXML(subnamenohirarchey)+"<br/>"+nlapiEscapeXML(subsdryAddrs)+"</td>";
						strName += "<td></td>";
						strName += "</tr>";
						...
						*/
							...
							strName += "<table margin-top = \"10px\" width = \"53%\" font-size=\"9.5\" border = \"1\" style=\"float: left;\">";
							strName += "<tr>";
							strName += "<td width = \"10%\" align=\"left\" style=\"border-bottom:1px; background-color:#CCCCCC;\"><span>&nbsp;<b>Subsidiary Details</b></span></td>";
							strName += "</tr>";
							
							strName += "<tr>";
						    strName += "<td width = \"12%\" align=\"left\" style=\"border-bottom:1px;\" line-height=\"18px\"><span><b>"+nlapiEscapeXML(subnamenohirarchey)+"</b><br/>"+nlapiEscapeXML(subsdryAddrs)+"</span></td>";
							strName += "</tr>";
							   
							strName += "<tr>";
							strName += "<td width = \"10%\" align=\"left\" style=\"border-bottom:1px; background-color:#CCCCCC;\"><span>&nbsp;<b>Bill To</b></span></td>";
							strName += "</tr>";
							
							strName += "<tr>";
							strName += "<td width = \"12%\" align=\"left\" line-height=\"18px\"><span><b>"+nlapiEscapeXML(customerName)+"</b><br/>"+nlapiEscapeXML(addressText1)+"</span></td>";
							strName += "</tr>";
							strName += "</table>";
								
										
							strName += "<table width = \"47%\" margin-top = \"10px\" font-size=\"9.5\" border = \"1\" style=\"float: left; margin-left:130px;\">";
							strName += "<tr>";
							strName += "<td align=\"left\" style=\"border-bottom:1px; background-color:#CCCCCC;\"><span>&nbsp;<b>Statment Date</b></span></td>";
							strName += "</tr>";
							
							strName += "<tr>";
						    strName += "<td align=\"left\" style=\"border-bottom:1px;\"><span>"+enddate+"</span></td>";
							strName += "</tr>";
							
							strName += "<tr>";
							strName += "<td align=\"left\" style=\"border-bottom:1px; background-color:#CCCCCC;\"><span>&nbsp;<b>Amount Due</b></span></td>";
							strName += "</tr>";
							
							strName += "<tr>";
							strName += "<td align=\"left\" style=\"border-bottom:1px;\"><span>"+formatNumber(parseFloat(openingBalance).toFixed(2))+"</span>&nbsp;&nbsp;</td>";
							strName += "</tr>";
				  
					        strName += "<tr>";
						    strName += "<td align=\"left\" style=\"border-bottom:1px; background-color:#CCCCCC;\"><span>&nbsp;<b>Currency</b></span></td>";
						    strName += "</tr>";
						    
						    strName += "<tr>";
							strName += "<td align=\"left\" style=\"border-bottom:1px;\"><span>"+linecurr+"</span></td>";
							strName += "</tr>";
				  
							strName += "<tr>";
							strName += "<td align=\"left\" style=\"border-bottom:1px; background-color:#CCCCCC;\"><span>&nbsp;<b>Payment Terms</b></span></td>";
							strName += "</tr>";
							
							strName += "<tr>";
							strName += "<td align=\"left\"><span>"+terms+"</span></td>";
							strName += "</tr>";
							strName += "</table>";
		...
		strName += "<tr>";
		strName += "<td  background-color = \"#DEDBDB\" align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-top=\"solid 1px black\" border-left=\"solid 1px black\" width=\"18\%\"><p style=\"text-align: center;\"><b>Document No</b></p></td>";
		strName += "<td  background-color = \"#DEDBDB\" align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-top=\"solid 1px black\" border-left=\"solid 1px black\" width=\"43\%\"><b>Memo</b></td>";
		strName += "<td  background-color = \"#DEDBDB\" align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-top=\"solid 1px black\" border-left=\"solid 1px black\" width=\"27\%\"><b>Description</b></td>";
		...
		strName += "<td  background-color = \"#DEDBDB\" align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-top=\"solid 1px black\" border-left=\"solid 1px black\" width=\"25\%\"><b>Document<br/>Date</b></td>";
		strName += "<td  background-color = \"#DEDBDB\" align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-top=\"solid 1px black\" border-left=\"solid 1px black\" width=\"13\%\"><b>Due Date</b></td>";
		strName += "<td  background-color = \"#DEDBDB\" align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-top=\"solid 1px black\" border-left=\"solid 1px black\" width=\"20\%\"><b>Debit</b></td>";
		strName += "<td  background-color = \"#DEDBDB\" align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-top=\"solid 1px black\" border-left=\"solid 1px black\" width=\"20\%\"><b>Credit</b></td>";
		strName += "<td  background-color = \"#DEDBDB\" align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-top=\"solid 1px black\" border-left=\"solid 1px black\" border-right=\"solid 1px black\" width=\"20\%\"><b>Balance</b></td>";
		strName += "</tr>";
		...
		strName += "<tr>";
		strName += "<td   align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\"  border-left=\"solid 1px black\" width=\"18\%\"><b></b></td>";
		strName += "<td   align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\"  border-left=\"solid 1px black\" width=\"43\%\"><b></b></td>";
		strName += "<td   align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\"  border-left=\"solid 1px black\" width=\"27\%\"><b></b></td>";
		//strName += "<td   align = \"center\" font-size=\"9\" border-bottom=\"solid 1px black\"  border-left=\"solid 1px black\" width=\"28\%\"><b></b></td>";
		strName += "<td   align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\"  border-left=\"solid 1px black\" width=\"25\%\"><b></b></td>";
		strName += "<td  align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\"  border-left=\"solid 1px black\" width=\"13\%\"><p style=\"text-align: center;\"><b>Opening Balance</b></p></td>";
		strName += "<td   align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\"  border-left=\"solid 1px black\" width=\"20\%\"><b></b></td>";
		strName += "<td   align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\"  border-left=\"solid 1px black\" width=\"20\%\"><b></b></td>";
		strName += "<td   align = \"right\" font-size=\"9.5\" border-bottom=\"solid 1px black\"  border-left=\"solid 1px black\" border-right=\"solid 1px black\" width=\"20\%\"><b>"+formatNumber(parseFloat(openingBalance).toFixed(2))+"</b></td>";
		strName += "</tr>";
			...
			//////nlapiLogExecution('DEBUG', 'searchVendorTransactions', 'openingBalance = end ');
		 	...
		 	if (searchResults != null && searchResults != '')
		 	{
				...
				for (var i = 0;  i < searchResults.length; i++) 
				{
					...
					{
						strName += "<td align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"18\%\">"+val_docid+"</td>";
					}
					else 
					{
						val_docid =' ';
					...
					{
						strName += "<td style=\"overflow-wrap: break-word; word-wrap: break-word;  hyphens: auto;\" align = \"left\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"43\%\"><p>"+memo+"</p></td>";
					}
					else 
					{
						memo =' ';
						...
						{
							strName += "<td align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"27\%\">"+type+"</td>";
						}
						else 
						{
							type =' ';
						...
						{
							strName += "<td align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"25\%\">"+val_docdate+"</td>";
						}
						else 
						{
							val_docdate =' ';
						...
						{
							strName += "<td padding = \"1\" align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"13\%\" style=\"word-break: break-all; white-space: normal;\">"+val_duedate+"</td>";
						}
						else 
						{
							val_duedate =' ';
						...
						if (debitamount == null && debitamount == '' && debitamount == undefined && debitamount == 'NaN' ) 
						{
								...
								debitamount ='0';
								strName += "<td align = \"right\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"20\%\">" +formatNumber(debitamount)+"</td>";
						...
						if (creditamount == null && creditamount == '' && creditamount == undefined && creditamount == 'NaN') 
						{
								...
								creditamount =' ';
								strName += "<td align = \"right\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"20\%\">" +formatNumber(creditamount)+"</td>";
						...
						if (updateOpeningBal == null && updateOpeningBal == '' && updateOpeningBal == undefined && updateOpeningBal == 'NaN') 
						{
							...
							updateOpeningBal =' ';
								strName += "<td align = \"right\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" border-right=\"solid 1px black\" width=\"20\%\">"+formatNumber(updateOpeningBal)+"</td>";
				
						}
						else 
						{
							strName += "<td align = \"right\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" border-right=\"solid 1px black\" width=\"20\%\">"+formatNumber(updateOpeningBal.toFixed(2))+"</td>";
						}
		...
		//-----------------------------Fetch Values-------------------------------------------
			...
			strName += "<tr>";
			strName += "<td  background-color = \"#DEDBDB\" align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"15\%\"></td>";
			strName += "<td  background-color = \"#DEDBDB\" align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"20\%\"></td>";
			strName += "<td  background-color = \"#DEDBDB\" align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"20\%\"></td>";
			...
			strName += "<td  background-color = \"#DEDBDB\" align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"30\%\"></td>";
			strName += "<td  background-color = \"#DEDBDB\" align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"40\%\"><b>Total</b></td>";
	     	strName += "<td  background-color = \"#DEDBDB\" align = \"right\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"20\%\"><b>"+DebitAmount+"</b></td>";
			strName += "<td  background-color = \"#DEDBDB\" align = \"right\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"20\%\"><b>"+CreditAmount+"</b></td>";
			strName += "<td  background-color = \"#DEDBDB\" align = \"right\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" border-right=\"solid 1px black\" width=\"20\%\"><b>"+formatNumber(updateOpeningBal.toFixed(2))+"</b></td>";
			strName += "</tr>";
			
		
			strName += "<tr>";
			strName += "<td   align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\"  border-left=\"solid 1px black\" width=\"15\%\"><b></b></td>";
			strName += "<td   align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\"  border-left=\"solid 1px black\" width=\"27\%\"><b></b></td>";
			strName += "<td   align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\"  border-left=\"solid 1px black\" width=\"27\%\"><b></b></td>";
			/*strName += "<td   align = \"center\" font-size=\"9\" border-bottom=\"solid 1px black\"  border-left=\"solid 1px black\" width=\"28\%\"><b></b></td>";*/
			strName += "<td   align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\"  border-left=\"solid 1px black\" width=\"30\%\"><b></b></td>";
			strName += "<td  align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\"  border-left=\"solid 1px black\" width=\"40\%\"><b>Closing Balance</b></td>";
			strName += "<td   align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\"  border-left=\"solid 1px black\" width=\"20\%\"><b></b></td>";
			strName += "<td   align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\"  border-left=\"solid 1px black\" width=\"20\%\"><b></b></td>";
			strName += "<td   align = \"right\" font-size=\"9.5\" border-bottom=\"solid 1px black\"  border-left=\"solid 1px black\" border-right=\"solid 1px black\" width=\"20\%\"><b>"+formatNumber(updateOpeningBal.toFixed(2))+"</b></td>";
			strName += "</tr>";
		...
		else 
		{
			...
			strName += "<td  background-color = \"#DEDBDB\" align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"30\%\"></td>";
			strName += "<td  background-color = \"#DEDBDB\" align = \"center\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"40\%\"><b>Total</b></td>";
	     	strName += "<td  background-color = \"#DEDBDB\" align = \"right\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"30\%\"><b>0.00</b></td>";
			strName += "<td  background-color = \"#DEDBDB\" align = \"right\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"15\%\"><b>0.00</b></td>";
			strName += "<td  background-color = \"#DEDBDB\" align = \"right\" font-size=\"9.5\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" border-right=\"solid 1px black\" width=\"20\%\"><b>"+FinBal+"</b></td>";
			strName += "</tr>";
		...
		else if(AsDateof != null && AsDateof != '' && AsDateof != undefined)
		{
			...
			columns[1] = new nlobjSearchColumn("fxamount");
		 	...
		 	filters.push(new nlobjSearchFilter ('currency', null, 'anyof', currency_a));
			var searchResults = nlapiSearchRecord('transaction', 'customsearch_ar_report_2', filters, columns);
			////nlapiLogExecution('DEBUG', 'searchVendorTransactions', 'searchResults= '+searchResults);
		 	var breakFlag = 0;
		 	...
		 	if (searchResults != null && searchResults != '')
		 	{
		 		...
		 		{
		 		    	var IntID = searchResults[j].getValue("internalid");
		 			  var Name = searchResults[j].getValue("entity");
					  var DocNum = searchResults[j].getValue("tranid");
					  var tranDate = searchResults[j].getValue("trandate");
					  var Memo = searchResults[j].getValue("memo");
					  var tranAmt =searchResults[j].getValue("fxamount");
					  var Balance = searchResults[j].getValue("fxamountremaining");
					  var DebitAmt = searchResults[j].getValue("debitfxamount");
					  var CreditAmt = searchResults[j].getValue("creditfxamount");
					  
					  var PayAmt =searchResults[j].getValue("fxamount","applyingTransaction");
					  
					  if(PayAmt != null && PayAmt != undefined && PayAmt != '')
					  {
			...
			nlapiLogExecution('DEBUG', 'getOpeningBalance', 'ReportMap = ' + searchResults.length);
					for(var j=0;j<searchResults.length;j++)
						{
						  var CustName = searchResults[j].getValue("entity",null,"GROUP");
						  var CustDocNum = searchResults[j].getValue("tranid",null,"GROUP");
						  var CusttranDate = searchResults[j].getValue("trandate",null,"GROUP");
						  var CustMemo = searchResults[j].getValue("memo",null,"GROUP");
						  var CusttranAmt =searchResults[j].getValue("fxamount",null,"SUM");
						  var Balance = searchResults[j].getValue("fxamountremaining",null,"SUM");
						  
						  var CustPayAmt = parseFloat(CusttranAmt)-parseFloat(Balance);
						  if(CustPayAmt < 0)
						  {
							  CustPayAmt =-(CustPayAmt);
						  }
						  
						  var DueDate=searchResults[j].getValue("duedate",null,"GROUP");//DueDate
							
						  totDeb +=parseFloat(CusttranAmt);
						  totCred +=parseFloat(CustPayAmt);
						  ...
						  strName += "<tr>";
							...
							strName += "<td padding = \"1\" align = \"center\" font-size=\"7\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"17\%\" style=\"word-break: break-all; white-space: normal;\"></td>";
								...
								if (CusttranAmt == null && CusttranAmt == '' && CusttranAmt == undefined && CusttranAmt == 'NaN' ) 
								{
									
									CusttranAmt ='0';
										strName += "<td align = \"right\" font-size=\"7\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"20\%\">" +formatNumber(CusttranAmt)+"</td>";
							
								}
								else 
								{
									
									strName += "<td align = \"right\" font-size=\"7\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"20\%\">" +formatNumber(CusttranAmt.toFixed(2))+"</td>";
								}
								
								if (CustPayAmt == null && CustPayAmt == '' && CustPayAmt == undefined && CustPayAmt == 'NaN') 
								{
							
									CustPayAmt =' ';
										strName += "<td align = \"right\" font-size=\"7\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"20\%\">" +formatNumber(CustPayAmt)+"</td>";
						
								}
								else 
								{
									strName += "<td align = \"right\" font-size=\"7\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" width=\"20\%\">" +formatNumber(CustPayAmt.toFixed(2))+"</td>";
								}
								...
								{
									strName += "<td align = \"right\" font-size=\"7\" border-bottom=\"solid 1px black\" border-left=\"solid 1px black\" border-right=\"solid 1px black\" width=\"20\%\">"+formatNumber(Balance.toFixed(2))+"</td>";
								}
	...
	//}//end else for loop
		...
		xml += "<pdf><head><macrolist><macro id=\"myfooter\"><p align=\"center\"><b>Note:This is a system generated document. In case of any differences, revert within 3 working days or this statement of account is deemed accepted</b><br/><br/><pagenumber /></p></macro></macrolist></head>\n<body size= \"A4\" header=\"nlheader\" header-height=\"10%\" footer=\"myfooter\" footer-height=\"0.5in\" font-size=\"10\">\n";
		...
		response.setContentType('PDF','CustomerStatement.pdf', 'inline');

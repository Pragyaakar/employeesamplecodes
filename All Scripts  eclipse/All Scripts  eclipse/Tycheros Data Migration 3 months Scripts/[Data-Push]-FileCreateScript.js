...
{	
	...
	*/
	...
	var s_JSON_Data =[];
	var searchId='customsearch_tm_trans_for_integration__2';
	...
	resultSet =getSavedSearchResult(null, searchId, null)
			if(resultSet!='' && resultSet!= null && resultSet !='undefined')
			{
				...
				for(var i=0;i<resultSet.length;i++)//resultSet.length
					...
					//===============================================================		
						    if(type =='CustInvc' || type =='CashSale') //CustInvc ..SalesOrd
							{
								  ...
								  for( var l=1;l<=lineCount;l++)
									{
									    ...
									    var category = loadRec.getLineItemValue('expense','category',l);

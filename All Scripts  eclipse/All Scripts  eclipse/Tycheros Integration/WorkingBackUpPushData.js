					...
					//===============================================================		
						    if(type =='CustInvc') //CustInvc ..SalesOrd
							{
							  ...
							  if(loadRec != null && loadRec != '' && loadRec !=undefined)
							  {
                                ...
                                if(isTax =='T')
                                   {
                                    var TaxItem = loadRec.getFieldText('taxitem');
                                   }                                
								  ...
								  for( var l1=1;l1<=lineCount1;l1++)
									{
									  ...
									  var name = loadRec.getLineItemText('other','entity',l1);
									  var number = loadRec.getLineItemValue('other','refnum',l1);
									  var acc = loadRec.getLineItemText('other','account',l1);
									  var amt = loadRec.getLineItemValue('other','amount',l1);
									  var dept = loadRec.getLineItemText('other','department',l1);
									  var loc = loadRec.getLineItemText('other','location',l1);
								  ...
								  for( var l2=1;l2<=lineCount2;l2++)
									{
									    	...
									    	var cashBackAcc = loadRec.getLineItemText('cashback','account',l2);
										    
										    var cashBackAmt = loadRec.getLineItemValue('cashback','amount',l2);
										    
                                            var cashBackDept = loadRec.getLineItemText('cashback','department',l2);
										    
										    var cashBackLoc = loadRec.getLineItemText('cashback','location',l2);

...
{
	var myCSV_data = nlapiRequestURL('https://432868.app.netsuite.com/core/media/media.nl?id=14542857&c=432868&h=621a2c52ef8a38698ac5&_xt=.json',null,null);
		   ...
		   for(var l1=0;l1<otherAccArr.length;l1++)
			{
			   ...
			   if(otherNameArr[l1] != null && otherNameArr[l1] != undefined && otherNameArr[l1] != '')
				{
				   var setLineName = FindEntitySearch(otherNameArr[l1].toString());
			   ...
			   if(otherDepArr[l1] != null && otherDepArr[l1] != undefined && otherDepArr[l1] != '')
				{
				   var setLineDep = FindDepartment(otherDepArr[l1].toString());
			   ...
			   if(otherLocArr[l1] != null && otherLocArr[l1] != undefined && otherLocArr[l1] != '')
				{
				   var setLineLoc = FindLocation(otherLocArr[l1].toString());
		   ...
		   for(var l3=0;l3<cashBackAccArr.length;l3++)
			{
			   ...
			   if(cashBackDepArr[l3] != null && cashBackDepArr[l3] != undefined && cashBackDepArr[l3] != '')
				{
				   var setLineDep1 = FindDepartment(cashBackDepArr[l3].toString());
			   ...
			   if(cashbackLocArr[l3] != null && cashbackLocArr[l3] != undefined && cashbackLocArr[l3] != '')
				{
				   var setLineLoc1 = FindLocation(cashbackLocArr[l3].toString());
...
{ 
	...
	if(Class != null && Class != '')
    {
	 filters[0] = new nlobjSearchFilter('name', null,'contains',Class.trim());
	}
...
{ 
    ...
    {
	 filters[0] = new nlobjSearchFilter('entityid', null,'contains',customer.trim());
	}
...
{ 
    ...
    {
	 filters[0] = new nlobjSearchFilter('name', null,'contains',department.trim());
	}
...
{ 
    ...
    {
	 filters[0] = new nlobjSearchFilter('name', null,'contains',location.trim());
	}
...
{ 
	...
	if(item != null && item != '')
    {
	 filters[0] = new nlobjSearchFilter('name', null,'contains',item.trim());
	}

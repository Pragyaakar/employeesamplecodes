 ...
 try
 {
	...
	for(var i =0;i<datain.length;i++)
	{
		...
		else if(type =='VendPymt')
		{
			  ...
			  var docNum =checkData['record_trans_num'];
		...
		else if(type =='Journal')
		{
			...
			var locArr= checkData['record_location_line'];
			 ...
			 createJEfunction(TranDate,docNum,AccArr,debitArr,creditArr,nameArr,memoArr,deprtmentArr,locArr);
		}
	...
	nlapiLogExecution('DEBUG','ERROR',' Error Array -->'+issueArr)	
...
function createInvoiceFunction(docNum,customer,tranDate,department,location,salesEffDate,shipDate,shipCarrier,actulShipDate,exchRate,estExtCost,estGrossProfit,estGrossProfitPercent,itemArr,qtyArr,qtyCommitArr,qtyFulfillArr,qtyInvoicedArr,qtyBackOrderArr,unitsArr,descripArr,priceLvlArr,rateArr,amtArr,costEstTypeArr)
{
	...
	if(estGrossProfitPercent != null && estGrossProfitPercent != undefined && estGrossProfitPercent != '')
	{
...
function createJEfunction(TranDate,docNum,AccArr,debitArr,creditArr,nameArr,memoArr,deprtmentArr,locArr)
{
...
{ 
    ...
    {
	 filters[0] = new nlobjSearchFilter('entityid', null,'contains',Vendor);
	}
...
{ 
    ...
    {
	 filters[0] = new nlobjSearchFilter('entityid', null,'contains',entity);
	}

	function suiteletTestLayout(request,response)
	{
		...
		var url = 'https://system.na3.netsuite.com/core/media/media.nl?id=2367&c=5375453&h=c0bc8d3a1844c25dcf66&whence='; 
		strName += "<table width=\"100\%\">";
		strName += "<tr>";
		strName += "<td>";
		strName +="<img height='80' width='120' src=\""+nlapiEscapeXML(url)+"\"></img>";
		strName += "</td>";

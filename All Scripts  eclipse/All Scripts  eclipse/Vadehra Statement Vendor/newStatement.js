...
function suiteletTestLayout(request, response)
{
 ...
 try{
	...
	var end = venstatobj.getFieldValue('custrecord_venstat_enddate')//custrecord_vendstat_enddate
	...
	var companyinfo = nlapiLoadConfiguration('companyinformation');
	       ...
	       // var url = 'https://system.netsuite.com/core/media/media.nl?id=11&c=5288045_SB1&h=aa54a558ce48064a6509'; 
			//var url ='https://system.na3.netsuite.com/core/media/media.nl?id=800&c=5375453&h=3c3b8f8daa2aa0447952'	
		     	var url = 'https://system.na3.netsuite.com/core/media/media.nl?id=718&c=5375453&h=106ce2de63d1615eceb6';    
				    strName += "<table  width=\"100\%\">";
					strName += "<tr>";
					strName += "<td>";
					strName +="<img height='80' width='100'  src=\""+nlapiEscapeXML(url)+"\"></img>";
					strName += "</td>";
	...
	*/
	...
	for (var z = 0; z < vendor_a.length; z++) 
	{
		...
		if (vendor != null && vendor != '' && vendor != undefined) 
		{
			...
			//	nlapiLogExecution('DEBUG', 'searchVendorTransactions', 'custCurrency = ' + custCurrency);
				...
				var openingBalance = getOpeningBalance(vendor, locationname,start);
	...
	strName += "<td  width = \"100\%\"  align=\"center\"><b></b></td>";	
	strName += "<td  width = \"100\%\"  align=\"right\"><b>"+openingBalance+"</b></td>";
	strName += "</tr>";
	...
	var searchResults = nlapiSearchRecord('transaction', 'customsearch_vadehra_vendorstatement', filters, columns);
				...
				if ( i >= 900) {
				 ...
				 strName += "<tr>";
					...
					if (debitamount == null && debitamount == '' && debitamount == undefined && debitamount == 'NaN' ) 
					{
							...
							debitamount ='0';
							strName += "<td  width = \"100\%\"  align=\"right\">"+debitamount+"</td>";
					...
					if (creditamount == null && creditamount == '' && creditamount == undefined && creditamount == 'NaN') 
					{
							...
							creditamount =' ';
							strName += "<td  width = \"100\%\"  align=\"right\">"+creditamount+"</td>";
					...
					if (col_Bal == null && col_Bal == '' && col_Bal == undefined && col_Bal == 'NaN') 
					{
							...
							col_Bal =' ';
							strName += "<td  width = \"100\%\"  align=\"right\">"+col_Bal+"</td>";
      ...
      /*
			...
			*/
			...
			if (DebitAmount == null && DebitAmount == '' && DebitAmount == undefined && DebitAmount == 'NaN' ) 
			{
				...
				DebitAmount ='0';
					strName += "<td border-top=\"solid 1px black\" border-bottom=\"solid 1px black\" width = \"100\%\"  align=\"right\"><b>"+DebitAmount+"</b></td>";
			...
			if (CreditAmount == null && CreditAmount == '' && CreditAmount == undefined && CreditAmount == 'NaN') 
			{
				...
				CreditAmount ='0';
					strName += "<td border-top=\"solid 1px black\" border-bottom=\"solid 1px black\"  width = \"100\%\"  align=\"right\"><b>"+CreditAmount+"</b></td>";
			...
			if (EndBal == null && EndBal == '' && EndBal == undefined && EndBal == 'NaN') 
			{
				...
				EndBal ='0';
					strName += "<td border-top=\"solid 1px black\" border-bottom=\"solid 1px black\"  width = \"100\%\"  align=\"right\"><b>"+EndBal+"</b></td>";

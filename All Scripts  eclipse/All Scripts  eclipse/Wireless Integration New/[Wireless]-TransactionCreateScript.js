	...
	// nlapiLogExecution('DEBUG','postFunction',' *****string_data***** -->'+datain)
	 ...
	 try
	 {
		...
		for(var i=0;i<datain.length;i++)
		{
			...
			var CreatedFrom =checkData['record_created_from'];
			...
			else if(type =='CashSale')
			{
		        ...
		        if(location !=null && location != undefined && location != '')
		        {
		            ...
		            createCashSaleFunction(docNum,customer,tranDate,department,location,salesEffDate,shipDate,shipCarrier,actulShipDate,exchRate,estExtCost,estGrossProfit,estGrossProfitPercent,itemArr,qtyArr,qtyCommitArr,qtyFulfillArr,qtyInvoicedArr,qtyBackOrderArr,unitsArr,descripArr,priceLvlArr,rateArr,amtArr,costEstTypeArr,TaxItem,account,CreatedFrom);
				  ...
				  var ExpAmtArr = checkData['record_exp_line_amt'];
					...
					if(location != null && location != '' && location !=undefined)
				     ...
				     createVendorBillfunction(AccountName,recId,type,tranDate,docNum,Vendor,department,location,itemArr,qtyArr,
							   ...
							   rateArr,amtArr,AccArr,ExpAmtArr,ExplineDeptArr,ExplineClassArr,ExplineLocArr,ExplineCustArr,CreatedFrom);
...
function createCashSaleFunction(docNum,customer,tranDate,department,location,salesEffDate,shipDate,shipCarrier,actulShipDate,exchRate,estExtCost,estGrossProfit,estGrossProfitPercent,itemArr,qtyArr,qtyCommitArr,qtyFulfillArr,qtyInvoicedArr,qtyBackOrderArr,unitsArr,descripArr,priceLvlArr,rateArr,amtArr,costEstTypeArr,TaxItem,account)
{
		   ...
		   rateArr,amtArr,AccArr,ExpAmtArr,ExplineDeptArr,ExplineClassArr,ExplineLocArr,ExplineCustArr,CreatedFrom)
{
	...
	if(CreatedFrom != null && CreatedFrom != undefined && CreatedFrom != '')
	{
	  ...
	  var record = nlapiTransformRecord('salesorder', valueCust, 'itemfufillment');
	}
	else
	{
		var record = nlapiCreateRecord('itemfulfillment', {recordmode: 'dynamic'}); 
...
{ 
	...
	if(item != null && item != '')
    {
	 filters[0] = new nlobjSearchFilter('custitem_internalid', null,'equalto',item);

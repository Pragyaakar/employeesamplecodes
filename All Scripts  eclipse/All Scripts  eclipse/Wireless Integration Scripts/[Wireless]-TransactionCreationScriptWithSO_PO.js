...
{
	var myCSV_data = nlapiRequestURL('https://3572894.app.netsuite.com/core/media/media.nl?id=482264&c=3572894&h=a15bccf16ac37c01b2a5&_xt=.json',null,null);
		...
		for(var i=0;i<datain.length;i++)
		{
				  ...
				  var ExpAmtArr = checkData['record_exp_line_amt'];
					...
					if(location != null && location != '' && location !=undefined)
				     ...
				     createVendorBillfunction(AccountName,recId,type,tranDate,docNum,Vendor,department,location,itemArr,qtyArr,
							   ...
							   rateArr,amtArr,AccArr,ExpAmtArr,ExplineDeptArr,ExplineClassArr,ExplineLocArr,ExplineCustArr,InvDetailNumArr,InvDetailQtyArr,createdFrom,Memo);
				  ...
				  var ExpAmtArr = checkData['record_exp_line_amt'];
					...
					if(location != null && location != '' && location !=undefined)
				     ...
				     createCheckfunction(AccountName,recId,type,tranDate,docNum,Payee,department,location,itemArr,qtyArr,
							   lineDeptArr,lineClassArr,lineLocArr,lineCustArr,unitsArr,descripArr,vendNameArr,
							   rateArr,amtArr,AccArr,ExpAmtArr,ExplineDeptArr,ExplineClassArr,ExplineLocArr,ExplineCustArr,InvDetailNumArr,InvDetailQtyArr,Memo);
				  ...
				  var ExpAmtArr = checkData['record_exp_line_amt'];
					...
					if(location != null && location != '' && location !=undefined)
				     ...
				     createVendorCreditfunction(AccountName,recId,type,tranDate,docNum,Vendor,department,location,itemArr,qtyArr,
							   ...
							   DueDateArr,refNumArr,OrigAmtArr,AmtDueArr,DiscDateArr,DiscAvailArr,DiscTakeArr,PaymentArr,InvDetailNumArr,InvDetailQtyArr,createdFrom,Memo);
					...
					if(Location != null && Location != '' && Location !=undefined)
					 {
					  ...
					  createCustomerPaymentTrans(recId,AR_AccName,AccName,Payee,TranNum,CheckNum,Memo,Department,Location,DueDateArr
							  ,refNumArr,OrigAmtArr,AmtDueArr,DiscDateArr,DiscAvailArr,DiscTakeArr,PaymentArr,tranDate,DepositLineRefArr,DepositLineAmtArr,CredLineRefArr,CredLineAmtArr,PayMethod,pnref,cardNumber,cardExpiry,cardName,cardProcessor,PayMent);
			...
			else if(type =='Journal')
			{
				...
				var locArr= checkData['record_location_line'];
				 ...
				 createJEfunction(recId,TranDate,docNum,AccArr,debitArr,creditArr,nameArr,memoArr,deprtmentArr,locArr,ReverseTranDate,ReversedocNum);
			}
				   ...
				   if(AccName !=null && AccName != undefined && AccName != '')
					  ...
					  if(Department != null && Department != '' && Department !=undefined)
						...
						createInvAdjustment(recId,AccName,employee,docNum,tranDate,Memo,Location,itemArr,
								descripArr,rateArr,qtyArr,memoArr,serialArr,locArr);
			}
...
function createJEfunction(recId,TranDate,docNum,AccArr,debitArr,creditArr,nameArr,memoArr,deprtmentArr,locArr,ReverseTranDate,ReversedocNum)
{

...
function customerProfitabilityReport_optimizeSuit(request, response){
	...
	var allrep = request.getParameter('allrep');
			...
			filters[filters.length] = new nlobjSearchFilter('supervisor', null, 'anyof', user);
			  ...
			  var searchResults = nlapiSearchRecord('employee','customsearch_employe_supervisor',filters,columns);
				...
				if(searchResults)
				{
					...
					{	
					  AllRep.push(searchResults[result].getValue("internalid"));
			        }
					nlapiLogExecution('DEBUG', 'AllRep ='+AllRep);
					if(AllRep)
					{
                       ...
                       var myParams = [];
		                  ...
		                  myParams.custscript_start_date = startDate;
		                  myParams.custscript_end_date = endDate;
		                  myParams.custscript_all_rep = AllRep;
		                  myParams.custscript_isexcel = isExcel;

...
function(search, record, format, render, email, error, runtime, file, xml) {
	...
	try {
	   		...
	   		//var temp;
				...
				idArr.push(tranID);
		 		...
		 		{	
		 			...
		 			items.push(tranID);
				// check Customer load report prefernce from customer record  1 ID is for CSV
					if (LoadReptPref == '1'){
					   		...
					   		//else
					   			{
					   				//temp +=  Tckdate + '","' + TckNum + '","' + driver + '","' + memo + '","' + scaleNum + '","' + GrossWtg + '","' + tareWtg + '","' + netWtg + '","' + numLoads + '"\n"';
												...
												/*if(!temp){
 													...
 													//str =  Tckdate + '","' + TckNum + '","' + driver + '","' + memo + '","' + scaleNum + '","' + GrossWtg + '","' + tareWtg + '","' + netWtg + '","' + numLoads + '"\n"';
													//str = 
 												//	temp +=  Tckdate + '","' + TckNum + '","' + driver + '","' + memo + '","' + scaleNum + '","' + GrossWtg + '","' + tareWtg + '","' + netWtg + '","' + numLoads + '"\n"';
												 //temp = str +'' +temp;
												//}
			...
			try {
					...
					lineOne += nameText + '\n';
			   	   lineOne += 'Date' + ',' + 'Ticket #' + ',' + 'Driver' + ',' + 'Description' + ',' + 'Scale Tkt #' + ',' + 'Gross Wt' + ',' + 'Tare Wt' + ',' + 'Net Wt' + ',' + '#Lds';
